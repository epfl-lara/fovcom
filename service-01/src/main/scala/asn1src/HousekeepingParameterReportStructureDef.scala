...
@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 1556 /*(0 .. 4294967295) */

 

@inline @cCode.inline val ERR_ACN_ENCODE_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 1559 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 1560 /*  */
...
@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERVALUES_STRUCT1: Int = 1561 /*(0 .. 255) */

@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERVALUES: Int = 1566 /* */
