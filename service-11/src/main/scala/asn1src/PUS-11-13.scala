...
@opaque @inlineOnce
def TM_11_13_TimeBasedScheduleSummaryReport_report_Encode_loop(codec: ACN, report: TTM_11_13_TimeBasedScheduleSummaryReport_report, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == report.nCount) {
        ...
        val res = TM_11_13_TimeBasedScheduleSummaryReport_report_Encode_loop(codec, report, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_11_13_TimeBasedScheduleSummaryReport_report_ACN_Encode(codec: ACN, pVal: TTM_11_13_TimeBasedScheduleSummaryReport, TM_11_13_TimeBasedScheduleSummaryReport_n: ULong, report: TTM_11_13_TimeBasedScheduleSummaryReport_report): Either[Int, Int] = {
    ...
    TM_11_13_TimeBasedScheduleSummaryReport_report_Encode_loop(codec, report, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TM_11_13_TimeBasedScheduleSummaryReport_report_Decode_loop(codec: ACN, nCount: Int, report: Vector[TTM_11_13_Report], i1: Int): EitherMut[Int, Vector[TTM_11_13_Report]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TM_11_13_TimeBasedScheduleSummaryReport_report_Decode_loop(codec, nCount, report.append(report_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_11_13_TimeBasedScheduleSummaryReport_report_ACN_Decode(codec: ACN, TM_11_13_TimeBasedScheduleSummaryReport_n: ULong): EitherMut[Int, TTM_11_13_TimeBasedScheduleSummaryReport_report] = {
    ...
    val report =
        if ((TM_11_13_TimeBasedScheduleSummaryReport_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val report = TM_11_13_TimeBasedScheduleSummaryReport_report_Decode_loop(codec, report_nCount, Vector.empty[TTM_11_13_Report], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
