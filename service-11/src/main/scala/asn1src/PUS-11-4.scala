...
@opaque @inlineOnce
def TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_Encode_loop(codec: ACN, activities: TTC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == activities.nCount) {
        ...
        val res = TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_Encode_loop(codec, activities, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_ACN_Encode(codec: ACN, pVal: TTC_11_4_InsertActivitiesIntoTheTimeBasedSchedule, TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_n: ULong, activities: TTC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities): Either[Int, Int] = {
    ...
    TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_Encode_loop(codec, activities, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_Decode_loop(codec: ACN, nCount: Int, activities: Vector[TTC_11_4_Activity], i1: Int): EitherMut[Int, Vector[TTC_11_4_Activity]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_Decode_loop(codec, nCount, activities.append(activities_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_ACN_Decode(codec: ACN, TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_n: ULong): EitherMut[Int, TTC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities] = {
    ...
    val activities =
        if ((ULong.fromRaw(1) <= TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_n) && (TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val activities = TC_11_4_InsertActivitiesIntoTheTimeBasedSchedule_activities_Decode_loop(codec, activities_nCount, Vector.empty[TTC_11_4_Activity], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
