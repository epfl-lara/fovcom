...
@opaque @inlineOnce
def TC_11_24_EnableTimeBasedSchedulingGroups_groups_Encode_loop(codec: ACN, groups: TTC_11_24_EnableTimeBasedSchedulingGroups_groups, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == groups.nCount) {
        ...
        val res = TC_11_24_EnableTimeBasedSchedulingGroups_groups_Encode_loop(codec, groups, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_11_24_EnableTimeBasedSchedulingGroups_groups_ACN_Encode(codec: ACN, pVal: TTC_11_24_EnableTimeBasedSchedulingGroups, TC_11_24_EnableTimeBasedSchedulingGroups_n: ULong, groups: TTC_11_24_EnableTimeBasedSchedulingGroups_groups): Either[Int, Int] = {
    ...
    TC_11_24_EnableTimeBasedSchedulingGroups_groups_Encode_loop(codec, groups, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_11_24_EnableTimeBasedSchedulingGroups_groups_Decode_loop(codec: ACN, nCount: Int, groups: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_11_24_EnableTimeBasedSchedulingGroups_groups_Decode_loop(codec, nCount, groups.append(groups_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_11_24_EnableTimeBasedSchedulingGroups_groups_ACN_Decode(codec: ACN, TC_11_24_EnableTimeBasedSchedulingGroups_n: ULong): EitherMut[Int, TTC_11_24_EnableTimeBasedSchedulingGroups_groups] = {
    ...
    val groups =
        if ((TC_11_24_EnableTimeBasedSchedulingGroups_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val groups = TC_11_24_EnableTimeBasedSchedulingGroups_groups_Decode_loop(codec, groups_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
