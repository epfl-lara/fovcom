...
@opaque @inlineOnce
def TC_11_8_Groups_subschedule_ID_Encode_loop(codec: ACN, subschedule_ID: TTC_11_8_Groups_subschedule_ID, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == subschedule_ID.nCount) {
        ...
        val res = TC_11_8_Groups_subschedule_ID_Encode_loop(codec, subschedule_ID, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_11_8_Groups_subschedule_ID_ACN_Encode(codec: ACN, pVal: TTC_11_8_Groups, TC_11_8_Groups_n2: ULong, subschedule_ID: TTC_11_8_Groups_subschedule_ID): Either[Int, Int] = {
    ...
    TC_11_8_Groups_subschedule_ID_Encode_loop(codec, subschedule_ID, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_11_8_Groups_subschedule_ID_Decode_loop(codec: ACN, nCount: Int, subschedule_ID: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_11_8_Groups_subschedule_ID_Decode_loop(codec, nCount, subschedule_ID.append(subschedule_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_11_8_Groups_subschedule_ID_ACN_Decode(codec: ACN, TC_11_8_Groups_n2: ULong): EitherMut[Int, TTC_11_8_Groups_subschedule_ID] = {
    ...
    val subschedule_ID =
        if ((TC_11_8_Groups_n2 <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val subschedule_ID = TC_11_8_Groups_subschedule_ID_Decode_loop(codec, subschedule_ID_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def TC_11_8_SubSchedules_subschedule_ID_Encode_loop(codec: ACN, subschedule_ID: TTC_11_8_SubSchedules_subschedule_ID, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= subschedule_ID.nCount))
    require((0 <= subschedule_ID.nCount) && (subschedule_ID.nCount <= subschedule_ID.arr.size) && (subschedule_ID.arr.size <= 4095))
    require(codec.base.bitStream.validate_offset_bits((32L * (subschedule_ID.nCount - i1))))
    decreases(subschedule_ID.nCount - i1)
    if (i1 == subschedule_ID.nCount) {
        ...
        val res = TC_11_8_SubSchedules_subschedule_ID_Encode_loop(codec, subschedule_ID, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_11_8_SubSchedules_subschedule_ID_ACN_Encode(codec: ACN, pVal: TTC_11_8_SubSchedules, TC_11_8_SubSchedules_n1: ULong, subschedule_ID: TTC_11_8_SubSchedules_subschedule_ID): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    TC_11_8_SubSchedules_subschedule_ID_Encode_loop(codec, subschedule_ID, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_11_8_SubSchedules_subschedule_ID_Decode_loop(codec: ACN, nCount: Int, subschedule_ID: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    require((0 <= nCount) && (nCount <= 4095))
    require((0 <= i1) && (i1 <= nCount))
    require(subschedule_ID.size == i1)
    require(codec.base.bitStream.validate_offset_bits((32L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_11_8_SubSchedules_subschedule_ID_Decode_loop(codec, nCount, subschedule_ID.append(subschedule_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_11_8_SubSchedules_subschedule_ID_ACN_Decode(codec: ACN, TC_11_8_SubSchedules_n1: ULong): EitherMut[Int, TTC_11_8_SubSchedules_subschedule_ID] = {
    ...
    val subschedule_ID =
        if ((TC_11_8_SubSchedules_n1 <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val subschedule_ID = TC_11_8_SubSchedules_subschedule_ID_Decode_loop(codec, subschedule_ID_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
