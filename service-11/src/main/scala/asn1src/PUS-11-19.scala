...
@opaque @inlineOnce
def TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_Encode_loop(codec: ACN, subscheduleStatuses: TTM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == subscheduleStatuses.nCount) {
        ...
        val res = TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_Encode_loop(codec, subscheduleStatuses, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_ACN_Encode(codec: ACN, pVal: TTM_11_19_TimeBasedSubScheduleStatusReport, TM_11_19_TimeBasedSubScheduleStatusReport_n: ULong, subscheduleStatuses: TTM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses): Either[Int, Int] = {
    ...
    TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_Encode_loop(codec, subscheduleStatuses, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_Decode_loop(codec: ACN, nCount: Int, subscheduleStatuses: Vector[TTM_11_19_Status], i1: Int): EitherMut[Int, Vector[TTM_11_19_Status]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_Decode_loop(codec, nCount, subscheduleStatuses.append(subscheduleStatuses_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_ACN_Decode(codec: ACN, TM_11_19_TimeBasedSubScheduleStatusReport_n: ULong): EitherMut[Int, TTM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses] = {
    ...
    val subscheduleStatuses =
        if ((TM_11_19_TimeBasedSubScheduleStatusReport_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val subscheduleStatuses = TM_11_19_TimeBasedSubScheduleStatusReport_subscheduleStatuses_Decode_loop(codec, subscheduleStatuses_nCount, Vector.empty[TTM_11_19_Status], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
