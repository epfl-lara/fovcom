...
def TTM_9_2_CucTimeReport_IsConstraintValid(pVal: TTM_9_2_CucTimeReport): Either[ErrorCode, Int] =
{
...
def TTM_9_2_CucTimeReport_Initialize(): TTM_9_2_CucTimeReport = TTM_9_2_CucTimeReport(rateExponentialValue = SomeMut(ULong.fromRaw(0L)), spacecraftTime = TCDS_AbsoluteTime_PFC_2_Initialize(), spacecraftTimeReferenceStatus = SomeMut(ULong.fromRaw(0L)))

@opaque @inlineOnce 
def TTM_9_2_CucTimeReport_ACN_Encode(pVal: TTM_9_2_CucTimeReport, codec: ACN, bCheckConstraints: Boolean): Either[ErrorCode, Int] =  // acn:21
{
    require(codec.base.bitStream.validate_offset_bits(100L))
    TTM_9_2_CucTimeReport_IsConstraintValid(pVal) match
        case Left(l) => return Left(l)
        case Right(_) =>
    @ghost val oldCdc = snapshot(codec)
    @ghost val codec_0_1 = snapshot(codec)
    TM_9_2_CucTimeReport_rateExponentialValue_Optional_ACN_Encode(codec, pVal, pVal.rateExponentialValue) match {
        case Left(l) =>
            return Left(l)
        case Right(_) =>
            ()
    ...
    TM_9_2_CucTimeReport_spacecraftTimeReferenceStatus_Optional_ACN_Encode(codec, pVal, pVal.spacecraftTimeReferenceStatus) match {
        case Left(l) =>
            return Left(l)
        case Right(_) =>
            ()
...
@opaque @inlineOnce
def TM_9_2_CucTimeReport_rateExponentialValue_Optional_ACN_Encode(codec: ACN, pVal: TTM_9_2_CucTimeReport, rateExponentialValue: OptionMut[ULong]): Either[Int, Int] = {
...
@opaque @inlineOnce
def TM_9_2_CucTimeReport_spacecraftTimeReferenceStatus_Optional_ACN_Encode(codec: ACN, pVal: TTM_9_2_CucTimeReport, spacecraftTimeReferenceStatus: OptionMut[ULong]): Either[Int, Int] = {
...
@opaque @inlineOnce 
def TTM_9_2_CucTimeReport_ACN_Decode(codec: ACN): EitherMut[ErrorCode, TTM_9_2_CucTimeReport] =
{
    require(codec.base.bitStream.validate_offset_bits(100L))

    @ghost val oldCdc = snapshot(codec)
    @ghost val codec_0_1 = snapshot(codec)
    val pVal_rateExponentialValue = TM_9_2_CucTimeReport_rateExponentialValue_Optional_ACN_Decode(codec) match {
        case LeftMut(l) =>
            return LeftMut(l)
        case RightMut(v) =>
            v
    ...
    @ghost val codec_0_3 = snapshot(codec)
    val pVal_spacecraftTimeReferenceStatus = TM_9_2_CucTimeReport_spacecraftTimeReferenceStatus_Optional_ACN_Decode(codec) match {
        case LeftMut(l) =>
            return LeftMut(l)
        case RightMut(v) =>
            v
    ...
    val pVal = TTM_9_2_CucTimeReport(pVal_rateExponentialValue, pVal_spacecraftTime, pVal_spacecraftTimeReferenceStatus)
    ghostExpr {
        check(pVal.size(oldCdc.base.bitStream.bitIndex) == size_0 + size_1 + size_2)
    }

    TTM_9_2_CucTimeReport_IsConstraintValid(pVal) match
        case Left(l) => LeftMut[ErrorCode, TTM_9_2_CucTimeReport](l)
        case Right(_) => RightMut[ErrorCode, TTM_9_2_CucTimeReport](pVal)
}.ensuring { (res : EitherMut[ErrorCode, TTM_9_2_CucTimeReport]) =>
    res match {
        case LeftMut(_) =>
            true
        case RightMut(resVal) =>
            old(codec).base.buf == codec.base.buf && codec.base.bitStream.bitIndex == old(codec).base.bitStream.bitIndex + resVal.size(old(codec).base.bitStream.bitIndex) && TTM_9_2_CucTimeReport_IsConstraintValid(resVal).isRight
    }
}

@ghost @pure 
def TTM_9_2_CucTimeReport_ACN_Decode_pure(codec: ACN): (ACN, EitherMut[ErrorCode, TTM_9_2_CucTimeReport]) =
{
    require(codec.base.bitStream.validate_offset_bits(100L))
    val cpy = snapshot(codec)
    val res = TTM_9_2_CucTimeReport_ACN_Decode(cpy)
    (cpy, res)
}

@opaque @inlineOnce
def TM_9_2_CucTimeReport_rateExponentialValue_Optional_ACN_Decode(codec: ACN): EitherMut[Int, OptionMut[ULong]] = {
    require(codec.base.bitStream.validate_offset_bits(32L))
    @ghost val oldCdc = snapshot(codec)
...
@ghost @pure
def TM_9_2_CucTimeReport_rateExponentialValue_Optional_ACN_Decode_pure(codec: ACN): (ACN, EitherMut[Int, OptionMut[ULong]]) = {
    require(codec.base.bitStream.validate_offset_bits(32L))
    val cpy = snapshot(codec)
    val res = TM_9_2_CucTimeReport_rateExponentialValue_Optional_ACN_Decode(cpy)
    (cpy, res)
}
...
@opaque @inlineOnce
def TM_9_2_CucTimeReport_spacecraftTimeReferenceStatus_Optional_ACN_Decode(codec: ACN): EitherMut[Int, OptionMut[ULong]] = {
    require(codec.base.bitStream.validate_offset_bits(4L))
    @ghost val oldCdc = snapshot(codec)
...
@ghost @pure
def TM_9_2_CucTimeReport_spacecraftTimeReferenceStatus_Optional_ACN_Decode_pure(codec: ACN): (ACN, EitherMut[Int, OptionMut[ULong]]) = {
    require(codec.base.bitStream.validate_offset_bits(4L))
    val cpy = snapshot(codec)
    val res = TM_9_2_CucTimeReport_spacecraftTimeReferenceStatus_Optional_ACN_Decode(cpy)
    (cpy, res)
}
