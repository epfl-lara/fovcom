...
@inline @cCode.inline val ERR_PARAMETER_ID: Int = 713 /*param1 */

 

@inline @cCode.inline val ERR_ACN_ENCODE_PARAMETER_ID: Int = 716 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_PARAMETER_ID: Int = 717 /*  */
/*-- TParameterValue --------------------------------------------*/
...
@inline @cCode.inline val ERR_PARAMETERVALUE_PARAM1: Int = 718 /*(0 ..255) */

@inline @cCode.inline val ERR_PARAMETERVALUE: Int = 723 /* */
...
@inline @cCode.inline val ERR_PARAMETERMASK_PARAM1: Int = 728 /*(SIZE (16)) */

@inline @cCode.inline val ERR_PARAMETERMASK: Int = 733 /* */
