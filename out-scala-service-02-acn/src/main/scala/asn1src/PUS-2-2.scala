...
@opaque @inlineOnce
def PUS_2_2_TTC_2_2_DistributeRegisterCommands_registerCommands_pVal_registerCommands_registerCommands_Encode_loop(codec: ACN, registerCommands: TTC_2_2_DistributeRegisterCommands_registerCommands, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == registerCommands.nCount) {
        ...
        val res = PUS_2_2_TTC_2_2_DistributeRegisterCommands_registerCommands_pVal_registerCommands_registerCommands_Encode_loop(codec, registerCommands, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_2_2_DistributeRegisterCommands_registerCommands_ACN_Encode(codec: ACN, pVal: TTC_2_2_DistributeRegisterCommands, TC_2_2_DistributeRegisterCommands_n: ULong, registerCommands: TTC_2_2_DistributeRegisterCommands_registerCommands): Either[Int, Int] = {
    ...
    PUS_2_2_TTC_2_2_DistributeRegisterCommands_registerCommands_pVal_registerCommands_registerCommands_Encode_loop(codec, registerCommands, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_2_2_TTC_2_2_DistributeRegisterCommands_registerCommands_pVal_registerCommands_registerCommands_Decode_loop(codec: ACN, nCount: Int, registerCommands: Vector[TRegister], i1: Int): EitherMut[Int, Vector[TRegister]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_2_2_TTC_2_2_DistributeRegisterCommands_registerCommands_pVal_registerCommands_registerCommands_Decode_loop(codec, nCount, registerCommands.append(registerCommands_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_2_2_DistributeRegisterCommands_registerCommands_ACN_Decode(codec: ACN, TC_2_2_DistributeRegisterCommands_n: ULong): EitherMut[Int, TTC_2_2_DistributeRegisterCommands_registerCommands] = {
    ...
    val registerCommands =
        if ((ULong.fromRaw(1) <= TC_2_2_DistributeRegisterCommands_n) && (TC_2_2_DistributeRegisterCommands_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val registerCommands = PUS_2_2_TTC_2_2_DistributeRegisterCommands_registerCommands_pVal_registerCommands_registerCommands_Decode_loop(codec, registerCommands_nCount, Vector.empty[TRegister], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
