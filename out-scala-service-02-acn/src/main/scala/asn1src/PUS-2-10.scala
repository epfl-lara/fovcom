...
@opaque @inlineOnce
def PUS_2_10_TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_pVal_logicalDeviceCommands_logicalDeviceCommands_Encode_loop(codec: ACN, logicalDeviceCommands: TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == logicalDeviceCommands.nCount) {
        ...
        val res = PUS_2_10_TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_pVal_logicalDeviceCommands_logicalDeviceCommands_Encode_loop(codec, logicalDeviceCommands, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_ACN_Encode(codec: ACN, pVal: TTC_2_10_DistributeLogicalDeviceCommands, TC_2_10_DistributeLogicalDeviceCommands_n: ULong, logicalDeviceCommands: TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands): Either[Int, Int] = {
    ...
    PUS_2_10_TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_pVal_logicalDeviceCommands_logicalDeviceCommands_Encode_loop(codec, logicalDeviceCommands, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_2_10_TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_pVal_logicalDeviceCommands_logicalDeviceCommands_Decode_loop(codec: ACN, nCount: Int, logicalDeviceCommands: Vector[TLogicalDeviceCommand], i1: Int): EitherMut[Int, Vector[TLogicalDeviceCommand]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_2_10_TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_pVal_logicalDeviceCommands_logicalDeviceCommands_Decode_loop(codec, nCount, logicalDeviceCommands.append(logicalDeviceCommands_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_ACN_Decode(codec: ACN, TC_2_10_DistributeLogicalDeviceCommands_n: ULong): EitherMut[Int, TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands] = {
    ...
    val logicalDeviceCommands =
        if ((ULong.fromRaw(1) <= TC_2_10_DistributeLogicalDeviceCommands_n) && (TC_2_10_DistributeLogicalDeviceCommands_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val logicalDeviceCommands = PUS_2_10_TTC_2_10_DistributeLogicalDeviceCommands_logicalDeviceCommands_pVal_logicalDeviceCommands_logicalDeviceCommands_Decode_loop(codec, logicalDeviceCommands_nCount, Vector.empty[TLogicalDeviceCommand], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
