...
@opaque @inlineOnce
def PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReport_objectData_pVal_objectData_objectData_Encode_loop(codec: ACN, objectData: TTM_6_4_DumpedObjectMemoryDataReport_objectData, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == objectData.nCount) {
        ...
        val res = PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReport_objectData_pVal_objectData_objectData_Encode_loop(codec, objectData, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_6_4_DumpedObjectMemoryDataReport_objectData_ACN_Encode(codec: ACN, pVal: TTM_6_4_DumpedObjectMemoryDataReport, TM_6_4_DumpedObjectMemoryDataReport_n: ULong, objectData: TTM_6_4_DumpedObjectMemoryDataReport_objectData): Either[Int, Int] = {
    ...
    PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReport_objectData_pVal_objectData_objectData_Encode_loop(codec, objectData, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReport_objectData_pVal_objectData_objectData_Decode_loop(codec: ACN, nCount: Int, objectData: Vector[TObjectData], i1: Int): EitherMut[Int, Vector[TObjectData]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReport_objectData_pVal_objectData_objectData_Decode_loop(codec, nCount, objectData.append(objectData_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_6_4_DumpedObjectMemoryDataReport_objectData_ACN_Decode(codec: ACN, TM_6_4_DumpedObjectMemoryDataReport_n: ULong): EitherMut[Int, TTM_6_4_DumpedObjectMemoryDataReport_objectData] = {
    ...
    val objectData =
        if ((ULong.fromRaw(1) <= TM_6_4_DumpedObjectMemoryDataReport_n) && (TM_6_4_DumpedObjectMemoryDataReport_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val objectData = PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReport_objectData_pVal_objectData_objectData_Decode_loop(codec, objectData_nCount, Vector.empty[TObjectData], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_pVal_objectData_objectData_Encode_loop(codec: ACN, objectData: TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= objectData.nCount))
    require((1 <= objectData.nCount) && (objectData.nCount <= objectData.arr.size) && (objectData.arr.size <= 63))
    require(codec.base.bitStream.validate_offset_bits((32840L * (objectData.nCount - i1))))
    decreases(objectData.nCount - i1)
    if (i1 == objectData.nCount) {
        ...
        val res = PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_pVal_objectData_objectData_Encode_loop(codec, objectData, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_ACN_Encode(codec: ACN, pVal: TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid, TM_6_4_DumpedObjectMemoryDataReportMultipleMemid_n: ULong, objectData: TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_pVal_objectData_objectData_Encode_loop(codec, objectData, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_pVal_objectData_objectData_Decode_loop(codec: ACN, nCount: Int, objectData: Vector[TObjectData], i1: Int): EitherMut[Int, Vector[TObjectData]] = {
    require((1 <= nCount) && (nCount <= 63))
    require((0 <= i1) && (i1 <= nCount))
    require(objectData.size == i1)
    require(codec.base.bitStream.validate_offset_bits((32840L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_pVal_objectData_objectData_Decode_loop(codec, nCount, objectData.append(objectData_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_ACN_Decode(codec: ACN, TM_6_4_DumpedObjectMemoryDataReportMultipleMemid_n: ULong): EitherMut[Int, TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData] = {
    ...
    val objectData =
        if ((ULong.fromRaw(1) <= TM_6_4_DumpedObjectMemoryDataReportMultipleMemid_n) && (TM_6_4_DumpedObjectMemoryDataReportMultipleMemid_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val objectData = PUS_6_4_TTM_6_4_DumpedObjectMemoryDataReportMultipleMemid_objectData_pVal_objectData_objectData_Decode_loop(codec, objectData_nCount, Vector.empty[TObjectData], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
