...
@opaque @inlineOnce
def PUS_6_9_TTC_6_9_CheckRawMemoryData_dataAreas_pVal_dataAreas_dataAreas_Encode_loop(codec: ACN, dataAreas: TTC_6_9_CheckRawMemoryData_dataAreas, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == dataAreas.nCount) {
        ...
        val res = PUS_6_9_TTC_6_9_CheckRawMemoryData_dataAreas_pVal_dataAreas_dataAreas_Encode_loop(codec, dataAreas, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_6_9_CheckRawMemoryData_dataAreas_ACN_Encode(codec: ACN, pVal: TTC_6_9_CheckRawMemoryData, TC_6_9_CheckRawMemoryData_n: ULong, dataAreas: TTC_6_9_CheckRawMemoryData_dataAreas): Either[Int, Int] = {
    ...
    PUS_6_9_TTC_6_9_CheckRawMemoryData_dataAreas_pVal_dataAreas_dataAreas_Encode_loop(codec, dataAreas, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_6_9_TTC_6_9_CheckRawMemoryData_dataAreas_pVal_dataAreas_dataAreas_Decode_loop(codec: ACN, nCount: Int, dataAreas: Vector[TTC_6_9_DataArea], i1: Int): EitherMut[Int, Vector[TTC_6_9_DataArea]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_6_9_TTC_6_9_CheckRawMemoryData_dataAreas_pVal_dataAreas_dataAreas_Decode_loop(codec, nCount, dataAreas.append(dataAreas_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_6_9_CheckRawMemoryData_dataAreas_ACN_Decode(codec: ACN, TC_6_9_CheckRawMemoryData_n: ULong): EitherMut[Int, TTC_6_9_CheckRawMemoryData_dataAreas] = {
    ...
    val dataAreas =
        if ((ULong.fromRaw(1) <= TC_6_9_CheckRawMemoryData_n) && (TC_6_9_CheckRawMemoryData_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val dataAreas = PUS_6_9_TTC_6_9_CheckRawMemoryData_dataAreas_pVal_dataAreas_dataAreas_Decode_loop(codec, dataAreas_nCount, Vector.empty[TTC_6_9_DataArea], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
