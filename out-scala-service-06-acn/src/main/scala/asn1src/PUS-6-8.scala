...
@opaque @inlineOnce
def PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects_pVal_checkedObjects_checkedObjects_Encode_loop(codec: ACN, checkedObjects: TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == checkedObjects.nCount) {
        ...
        val res = PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects_pVal_checkedObjects_checkedObjects_Encode_loop(codec, checkedObjects, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_6_8_CheckedObjectMemoryDataReport_checkedObjects_ACN_Encode(codec: ACN, pVal: TTM_6_8_CheckedObjectMemoryDataReport, TM_6_8_CheckedObjectMemoryDataReport_n: ULong, checkedObjects: TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects): Either[Int, Int] = {
    ...
    PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects_pVal_checkedObjects_checkedObjects_Encode_loop(codec, checkedObjects, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects_pVal_checkedObjects_checkedObjects_Decode_loop(codec: ACN, nCount: Int, checkedObjects: Vector[TCheckedObject], i1: Int): EitherMut[Int, Vector[TCheckedObject]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects_pVal_checkedObjects_checkedObjects_Decode_loop(codec, nCount, checkedObjects.append(checkedObjects_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_6_8_CheckedObjectMemoryDataReport_checkedObjects_ACN_Decode(codec: ACN, TM_6_8_CheckedObjectMemoryDataReport_n: ULong): EitherMut[Int, TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects] = {
    ...
    val checkedObjects =
        if ((ULong.fromRaw(1) <= TM_6_8_CheckedObjectMemoryDataReport_n) && (TM_6_8_CheckedObjectMemoryDataReport_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val checkedObjects = PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReport_checkedObjects_pVal_checkedObjects_checkedObjects_Decode_loop(codec, checkedObjects_nCount, Vector.empty[TCheckedObject], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_pVal_checkedObjects_checkedObjects_Encode_loop(codec: ACN, checkedObjects: TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= checkedObjects.nCount))
    require((1 <= checkedObjects.nCount) && (checkedObjects.nCount <= checkedObjects.arr.size) && (checkedObjects.arr.size <= 63))
    require(codec.base.bitStream.validate_offset_bits((80L * (checkedObjects.nCount - i1))))
    decreases(checkedObjects.nCount - i1)
    if (i1 == checkedObjects.nCount) {
        ...
        val res = PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_pVal_checkedObjects_checkedObjects_Encode_loop(codec, checkedObjects, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_ACN_Encode(codec: ACN, pVal: TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid, TM_6_8_CheckedObjectMemoryDataReportMultipleMemid_n: ULong, checkedObjects: TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_pVal_checkedObjects_checkedObjects_Encode_loop(codec, checkedObjects, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_pVal_checkedObjects_checkedObjects_Decode_loop(codec: ACN, nCount: Int, checkedObjects: Vector[TCheckedObject], i1: Int): EitherMut[Int, Vector[TCheckedObject]] = {
    require((1 <= nCount) && (nCount <= 63))
    require((0 <= i1) && (i1 <= nCount))
    require(checkedObjects.size == i1)
    require(codec.base.bitStream.validate_offset_bits((80L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_pVal_checkedObjects_checkedObjects_Decode_loop(codec, nCount, checkedObjects.append(checkedObjects_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_ACN_Decode(codec: ACN, TM_6_8_CheckedObjectMemoryDataReportMultipleMemid_n: ULong): EitherMut[Int, TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects] = {
    ...
    val checkedObjects =
        if ((ULong.fromRaw(1) <= TM_6_8_CheckedObjectMemoryDataReportMultipleMemid_n) && (TM_6_8_CheckedObjectMemoryDataReportMultipleMemid_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val checkedObjects = PUS_6_8_TTM_6_8_CheckedObjectMemoryDataReportMultipleMemid_checkedObjects_pVal_checkedObjects_checkedObjects_Decode_loop(codec, checkedObjects_nCount, Vector.empty[TCheckedObject], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
