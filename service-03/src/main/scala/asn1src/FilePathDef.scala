...
@inline @cCode.inline val ERR_FILEPATH: Int = 3558 /* */
@inline @cCode.inline val ERR_FILEPATH_REPOSITORYPATH_2: Int = 3545 /* */
@inline @cCode.inline val ERR_FILEPATH_FILENAME_2: Int = 3555 /* */

 

@inline @cCode.inline val ERR_ACN_ENCODE_FILEPATH: Int = 3561 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_FILEPATH_REPOSITORYPATHLENGTH_UNINITIALIZED: Int = 3562 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_FILEPATH_REPOSITORYPATHLENGTH: Int = 3538 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_FILEPATH_REPOSITORYPATH: Int = 3543 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_FILEPATH_FILENAMELENGTH_UNINITIALIZED: Int = 3563 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_FILEPATH_FILENAMELENGTH: Int = 3548 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_FILEPATH_FILENAME: Int = 3553 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_FILEPATH: Int = 3564 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_FILEPATH_REPOSITORYPATHLENGTH: Int = 3539 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_FILEPATH_REPOSITORYPATH: Int = 3544 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_FILEPATH_FILENAMELENGTH: Int = 3549 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_FILEPATH_FILENAME: Int = 3554 /*  */
