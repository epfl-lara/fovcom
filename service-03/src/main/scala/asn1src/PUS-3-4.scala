...
@opaque @inlineOnce
def TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_Encode_loop(codec: ACN, diagnosticParameterReportStructure_ID: TTC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == diagnosticParameterReportStructure_ID.nCount) {
        ...
        val res = TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_Encode_loop(codec, diagnosticParameterReportStructure_ID, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_ACN_Encode(codec: ACN, pVal: TTC_3_4_DeleteDiagnosticParameterReportStructures, TC_3_4_DeleteDiagnosticParameterReportStructures_n: ULong, diagnosticParameterReportStructure_ID: TTC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID): Either[Int, Int] = {
    ...
    TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_Encode_loop(codec, diagnosticParameterReportStructure_ID, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_Decode_loop(codec: ACN, nCount: Int, diagnosticParameterReportStructure_ID: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_Decode_loop(codec, nCount, diagnosticParameterReportStructure_ID.append(diagnosticParameterReportStructure_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_ACN_Decode(codec: ACN, TC_3_4_DeleteDiagnosticParameterReportStructures_n: ULong): EitherMut[Int, TTC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID] = {
    ...
    val diagnosticParameterReportStructure_ID =
        if ((ULong.fromRaw(1) <= TC_3_4_DeleteDiagnosticParameterReportStructures_n) && (TC_3_4_DeleteDiagnosticParameterReportStructures_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val diagnosticParameterReportStructure_ID = TC_3_4_DeleteDiagnosticParameterReportStructures_diagnosticParameterReportStructure_ID_Decode_loop(codec, diagnosticParameterReportStructure_ID_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
