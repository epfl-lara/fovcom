...
@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 3498 /*(0 .. 4294967295) */

 

@inline @cCode.inline val ERR_ACN_ENCODE_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 3501 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 3502 /*  */
...
@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERVALUES_STRUCT1: Int = 3503 /*(0 .. 255) */

@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERVALUES: Int = 3508 /* */
