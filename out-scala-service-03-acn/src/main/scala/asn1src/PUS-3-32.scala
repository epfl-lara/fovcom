...
@opaque @inlineOnce
def PUS_3_32_TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_pVal_diagnosticParamererReportStructureIntervals_diagnosticParamererReportStructureIntervals_Encode_loop(codec: ACN, diagnosticParamererReportStructureIntervals: TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == diagnosticParamererReportStructureIntervals.nCount) {
        ...
        val res = PUS_3_32_TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_pVal_diagnosticParamererReportStructureIntervals_diagnosticParamererReportStructureIntervals_Encode_loop(codec, diagnosticParamererReportStructureIntervals, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_ACN_Encode(codec: ACN, pVal: TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures, TC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_n: ULong, diagnosticParamererReportStructureIntervals: TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals): Either[Int, Int] = {
    ...
    PUS_3_32_TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_pVal_diagnosticParamererReportStructureIntervals_diagnosticParamererReportStructureIntervals_Encode_loop(codec, diagnosticParamererReportStructureIntervals, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_3_32_TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_pVal_diagnosticParamererReportStructureIntervals_diagnosticParamererReportStructureIntervals_Decode_loop(codec: ACN, nCount: Int, diagnosticParamererReportStructureIntervals: Vector[TDiagnosticParameterReportStructureIntervals], i1: Int): EitherMut[Int, Vector[TDiagnosticParameterReportStructureIntervals]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_3_32_TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_pVal_diagnosticParamererReportStructureIntervals_diagnosticParamererReportStructureIntervals_Decode_loop(codec, nCount, diagnosticParamererReportStructureIntervals.append(diagnosticParamererReportStructureIntervals_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_ACN_Decode(codec: ACN, TC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_n: ULong): EitherMut[Int, TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals] = {
    ...
    val diagnosticParamererReportStructureIntervals =
        if ((ULong.fromRaw(1) <= TC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_n) && (TC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val diagnosticParamererReportStructureIntervals = PUS_3_32_TTC_3_32_ModifyTheCollectionIntervalOfDiagnosticParameterReportStructures_diagnosticParamererReportStructureIntervals_pVal_diagnosticParamererReportStructureIntervals_diagnosticParamererReportStructureIntervals_Decode_loop(codec, diagnosticParamererReportStructureIntervals_nCount, Vector.empty[TDiagnosticParameterReportStructureIntervals], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
