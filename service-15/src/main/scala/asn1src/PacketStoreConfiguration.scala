...
@opaque @inlineOnce
def PacketStoreConfiguration_configurationItems_Encode_loop(codec: ACN, configurationItems: TPacketStoreConfiguration_configurationItems, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == configurationItems.nCount) {
        ...
        val res = PacketStoreConfiguration_configurationItems_Encode_loop(codec, configurationItems, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def PacketStoreConfiguration_configurationItems_ACN_Encode(codec: ACN, pVal: TPacketStoreConfiguration, PacketStoreConfiguration_n: ULong, configurationItems: TPacketStoreConfiguration_configurationItems): Either[Int, Int] = {
    ...
    PacketStoreConfiguration_configurationItems_Encode_loop(codec, configurationItems, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PacketStoreConfiguration_configurationItems_Decode_loop(codec: ACN, nCount: Int, configurationItems: Vector[TPacketStoreConfigurationItem], i1: Int): EitherMut[Int, Vector[TPacketStoreConfigurationItem]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PacketStoreConfiguration_configurationItems_Decode_loop(codec, nCount, configurationItems.append(configurationItems_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def PacketStoreConfiguration_configurationItems_ACN_Decode(codec: ACN, PacketStoreConfiguration_n: ULong): EitherMut[Int, TPacketStoreConfiguration_configurationItems] = {
    ...
    val configurationItems =
        if ((ULong.fromRaw(1) <= PacketStoreConfiguration_n) && (PacketStoreConfiguration_n <= ULong.fromRaw(32))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val configurationItems = PacketStoreConfiguration_configurationItems_Decode_loop(codec, configurationItems_nCount, Vector.empty[TPacketStoreConfigurationItem], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
