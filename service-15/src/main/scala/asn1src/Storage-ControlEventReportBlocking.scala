...
@opaque @inlineOnce
def Storage_ControlEventReportBlockingConfiguration_tail_Encode_loop(codec: ACN, tail: TStorage_ControlEventReportBlockingConfiguration_tail, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == tail.nCount) {
        ...
        val res = Storage_ControlEventReportBlockingConfiguration_tail_Encode_loop(codec, tail, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def Storage_ControlEventReportBlockingConfiguration_tail_ACN_Encode(codec: ACN, pVal: TStorage_ControlEventReportBlockingConfiguration, Storage_ControlEventReportBlockingConfiguration_n2: ULong, tail: TStorage_ControlEventReportBlockingConfiguration_tail): Either[Int, Int] = {
    ...
    Storage_ControlEventReportBlockingConfiguration_tail_Encode_loop(codec, tail, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def Storage_ControlEventReportBlockingConfiguration_tail_Decode_loop(codec: ACN, nCount: Int, tail: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = Storage_ControlEventReportBlockingConfiguration_tail_Decode_loop(codec, nCount, tail.append(tail_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def Storage_ControlEventReportBlockingConfiguration_tail_ACN_Decode(codec: ACN, Storage_ControlEventReportBlockingConfiguration_n2: ULong): EitherMut[Int, TStorage_ControlEventReportBlockingConfiguration_tail] = {
    ...
    val tail =
        if ((Storage_ControlEventReportBlockingConfiguration_n2 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val tail = Storage_ControlEventReportBlockingConfiguration_tail_Decode_loop(codec, tail_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def Storage_ControlEventReportBlocking_configuration_Encode_loop(codec: ACN, configuration: TStorage_ControlEventReportBlocking_configuration, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == configuration.nCount) {
        ...
        val res = Storage_ControlEventReportBlocking_configuration_Encode_loop(codec, configuration, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def Storage_ControlEventReportBlocking_configuration_ACN_Encode(codec: ACN, pVal: TStorage_ControlEventReportBlocking, Storage_ControlEventReportBlocking_n1: ULong, configuration: TStorage_ControlEventReportBlocking_configuration): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    Storage_ControlEventReportBlocking_configuration_Encode_loop(codec, configuration, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def Storage_ControlEventReportBlocking_configuration_Decode_loop(codec: ACN, nCount: Int, configuration: Vector[TStorage_ControlEventReportBlockingConfiguration], i1: Int): EitherMut[Int, Vector[TStorage_ControlEventReportBlockingConfiguration]] = {
    require((0 <= nCount) && (nCount <= 31))
    require((0 <= i1) && (i1 <= nCount))
    ...
    (if (i1 == nCount) {
        ...
        val res = Storage_ControlEventReportBlocking_configuration_Decode_loop(codec, nCount, configuration.append(configuration_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def Storage_ControlEventReportBlocking_configuration_ACN_Decode(codec: ACN, Storage_ControlEventReportBlocking_n1: ULong): EitherMut[Int, TStorage_ControlEventReportBlocking_configuration] = {
    ...
    val configuration =
        if ((Storage_ControlEventReportBlocking_n1 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val configuration = Storage_ControlEventReportBlocking_configuration_Decode_loop(codec, configuration_nCount, Vector.empty[TStorage_ControlEventReportBlockingConfiguration], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
