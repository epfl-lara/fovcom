...
@opaque @inlineOnce
def TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_Encode_loop(codec: ACN, packetStoreStatusReports: TTM_15_19_PacketStoreStatusReport_packetStoreStatusReports, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == packetStoreStatusReports.nCount) {
        ...
        val res = TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_Encode_loop(codec, packetStoreStatusReports, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_ACN_Encode(codec: ACN, pVal: TTM_15_19_PacketStoreStatusReport, TM_15_19_PacketStoreStatusReport_n: ULong, packetStoreStatusReports: TTM_15_19_PacketStoreStatusReport_packetStoreStatusReports): Either[Int, Int] = {
    ...
    TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_Encode_loop(codec, packetStoreStatusReports, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_Decode_loop(codec: ACN, nCount: Int, packetStoreStatusReports: Vector[TTM_15_19_PacketStoreStatusReportItem], i1: Int): EitherMut[Int, Vector[TTM_15_19_PacketStoreStatusReportItem]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_Decode_loop(codec, nCount, packetStoreStatusReports.append(packetStoreStatusReports_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_ACN_Decode(codec: ACN, TM_15_19_PacketStoreStatusReport_n: ULong): EitherMut[Int, TTM_15_19_PacketStoreStatusReport_packetStoreStatusReports] = {
    ...
    val packetStoreStatusReports =
        if ((ULong.fromRaw(1) <= TM_15_19_PacketStoreStatusReport_n) && (TM_15_19_PacketStoreStatusReport_n <= ULong.fromRaw(32))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val packetStoreStatusReports = TM_15_19_PacketStoreStatusReport_packetStoreStatusReports_Decode_loop(codec, packetStoreStatusReports_nCount, Vector.empty[TTM_15_19_PacketStoreStatusReportItem], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
