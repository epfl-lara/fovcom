...
@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 509 /*(0 .. 4294967295) */

 

@inline @cCode.inline val ERR_ACN_ENCODE_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 512 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 513 /*  */
...
@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERVALUES_STRUCT1: Int = 514 /*(0 .. 255) */

@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERVALUES: Int = 519 /* */
