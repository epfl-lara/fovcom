...
@inline @cCode.inline val ERR_PARAMETER_ID: Int = 756 /*param1 */

 

@inline @cCode.inline val ERR_ACN_ENCODE_PARAMETER_ID: Int = 759 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_PARAMETER_ID: Int = 760 /*  */
/*-- TParameterValue --------------------------------------------*/
...
@inline @cCode.inline val ERR_PARAMETERVALUE_PARAM1: Int = 761 /*(0 ..255) */

@inline @cCode.inline val ERR_PARAMETERVALUE: Int = 766 /* */
...
@inline @cCode.inline val ERR_PARAMETERMASK_PARAM1: Int = 771 /*(SIZE (16)) */

@inline @cCode.inline val ERR_PARAMETERMASK: Int = 776 /* */
