...
@opaque @inlineOnce
def SingleEventDefinitionForwardControl_eventDefinition_ID_Encode_loop(codec: ACN, eventDefinition_ID: TSingleEventDefinitionForwardControl_eventDefinition_ID, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == eventDefinition_ID.nCount) {
        ...
        val res = SingleEventDefinitionForwardControl_eventDefinition_ID_Encode_loop(codec, eventDefinition_ID, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def SingleEventDefinitionForwardControl_eventDefinition_ID_ACN_Encode(codec: ACN, pVal: TSingleEventDefinitionForwardControl, SingleEventDefinitionForwardControl_n2: ULong, eventDefinition_ID: TSingleEventDefinitionForwardControl_eventDefinition_ID): Either[Int, Int] = {
    ...
    SingleEventDefinitionForwardControl_eventDefinition_ID_Encode_loop(codec, eventDefinition_ID, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def SingleEventDefinitionForwardControl_eventDefinition_ID_Decode_loop(codec: ACN, nCount: Int, eventDefinition_ID: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = SingleEventDefinitionForwardControl_eventDefinition_ID_Decode_loop(codec, nCount, eventDefinition_ID.append(eventDefinition_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def SingleEventDefinitionForwardControl_eventDefinition_ID_ACN_Decode(codec: ACN, SingleEventDefinitionForwardControl_n2: ULong): EitherMut[Int, TSingleEventDefinitionForwardControl_eventDefinition_ID] = {
    ...
    val eventDefinition_ID =
        if ((SingleEventDefinitionForwardControl_n2 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val eventDefinition_ID = SingleEventDefinitionForwardControl_eventDefinition_ID_Decode_loop(codec, eventDefinition_ID_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def EventDefinitionForwardControl_forwardControl_Encode_loop(codec: ACN, forwardControl: TEventDefinitionForwardControl_forwardControl, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == forwardControl.nCount) {
        ...
        val res = EventDefinitionForwardControl_forwardControl_Encode_loop(codec, forwardControl, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def EventDefinitionForwardControl_forwardControl_ACN_Encode(codec: ACN, pVal: TEventDefinitionForwardControl, EventDefinitionForwardControl_n1: ULong, forwardControl: TEventDefinitionForwardControl_forwardControl): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    EventDefinitionForwardControl_forwardControl_Encode_loop(codec, forwardControl, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def EventDefinitionForwardControl_forwardControl_Decode_loop(codec: ACN, nCount: Int, forwardControl: Vector[TSingleEventDefinitionForwardControl], i1: Int): EitherMut[Int, Vector[TSingleEventDefinitionForwardControl]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = EventDefinitionForwardControl_forwardControl_Decode_loop(codec, nCount, forwardControl.append(forwardControl_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def EventDefinitionForwardControl_forwardControl_ACN_Decode(codec: ACN, EventDefinitionForwardControl_n1: ULong): EitherMut[Int, TEventDefinitionForwardControl_forwardControl] = {
    ...
    val forwardControl =
        if ((ULong.fromRaw(1) <= EventDefinitionForwardControl_n1) && (EventDefinitionForwardControl_n1 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val forwardControl = EventDefinitionForwardControl_forwardControl_Decode_loop(codec, forwardControl_nCount, Vector.empty[TSingleEventDefinitionForwardControl], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
