...
@opaque @inlineOnce
def ServiceTypeForwardControl_messages_Encode_loop(codec: ACN, messages: TServiceTypeForwardControl_messages, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == messages.nCount) {
        ...
        val res = ServiceTypeForwardControl_messages_Encode_loop(codec, messages, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def ServiceTypeForwardControl_messages_ACN_Encode(codec: ACN, pVal: TServiceTypeForwardControl, ServiceTypeForwardControl_n3: ULong, messages: TServiceTypeForwardControl_messages): Either[Int, Int] = {
    ...
    ServiceTypeForwardControl_messages_Encode_loop(codec, messages, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def ServiceTypeForwardControl_messages_Decode_loop(codec: ACN, nCount: Int, messages: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = ServiceTypeForwardControl_messages_Decode_loop(codec, nCount, messages.append(messages_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def ServiceTypeForwardControl_messages_ACN_Decode(codec: ACN, ServiceTypeForwardControl_n3: ULong): EitherMut[Int, TServiceTypeForwardControl_messages] = {
    ...
    val messages =
        if ((ServiceTypeForwardControl_n3 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val messages = ServiceTypeForwardControl_messages_Decode_loop(codec, messages_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def SingleApplicationProcessForwardControl_services_Encode_loop(codec: ACN, services: TSingleApplicationProcessForwardControl_services, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == services.nCount) {
        ...
        val res = SingleApplicationProcessForwardControl_services_Encode_loop(codec, services, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def SingleApplicationProcessForwardControl_services_ACN_Encode(codec: ACN, pVal: TSingleApplicationProcessForwardControl, SingleApplicationProcessForwardControl_n2: ULong, services: TSingleApplicationProcessForwardControl_services): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    SingleApplicationProcessForwardControl_services_Encode_loop(codec, services, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def SingleApplicationProcessForwardControl_services_Decode_loop(codec: ACN, nCount: Int, services: Vector[TServiceTypeForwardControl], i1: Int): EitherMut[Int, Vector[TServiceTypeForwardControl]] = {
    require((0 <= nCount) && (nCount <= 31))
    require((0 <= i1) && (i1 <= nCount))
    ...
    (if (i1 == nCount) {
        ...
        val res = SingleApplicationProcessForwardControl_services_Decode_loop(codec, nCount, services.append(services_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def SingleApplicationProcessForwardControl_services_ACN_Decode(codec: ACN, SingleApplicationProcessForwardControl_n2: ULong): EitherMut[Int, TSingleApplicationProcessForwardControl_services] = {
    ...
    val services =
        if ((SingleApplicationProcessForwardControl_n2 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val services = SingleApplicationProcessForwardControl_services_Decode_loop(codec, services_nCount, Vector.empty[TServiceTypeForwardControl], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def ApplicationProcessForwardControl_forwardControl_Encode_loop(codec: ACN, forwardControl: TApplicationProcessForwardControl_forwardControl, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == forwardControl.nCount) {
        ...
        val res = ApplicationProcessForwardControl_forwardControl_Encode_loop(codec, forwardControl, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def ApplicationProcessForwardControl_forwardControl_ACN_Encode(codec: ACN, pVal: TApplicationProcessForwardControl, ApplicationProcessForwardControl_n1: ULong, forwardControl: TApplicationProcessForwardControl_forwardControl): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    ApplicationProcessForwardControl_forwardControl_Encode_loop(codec, forwardControl, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def ApplicationProcessForwardControl_forwardControl_Decode_loop(codec: ACN, nCount: Int, forwardControl: Vector[TSingleApplicationProcessForwardControl], i1: Int): EitherMut[Int, Vector[TSingleApplicationProcessForwardControl]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = ApplicationProcessForwardControl_forwardControl_Decode_loop(codec, nCount, forwardControl.append(forwardControl_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def ApplicationProcessForwardControl_forwardControl_ACN_Decode(codec: ACN, ApplicationProcessForwardControl_n1: ULong): EitherMut[Int, TApplicationProcessForwardControl_forwardControl] = {
    ...
    val forwardControl =
        if ((ULong.fromRaw(1) <= ApplicationProcessForwardControl_n1) && (ApplicationProcessForwardControl_n1 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val forwardControl = ApplicationProcessForwardControl_forwardControl_Decode_loop(codec, forwardControl_nCount, Vector.empty[TSingleApplicationProcessForwardControl], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
