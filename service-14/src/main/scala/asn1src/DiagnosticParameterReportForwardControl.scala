...
@opaque @inlineOnce
def SingleDiagnosticParameterReportForwardControlSubsampling_structure_Encode_loop(codec: ACN, structure: TSingleDiagnosticParameterReportForwardControlSubsampling_structure, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == structure.nCount) {
        ...
        val res = SingleDiagnosticParameterReportForwardControlSubsampling_structure_Encode_loop(codec, structure, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def SingleDiagnosticParameterReportForwardControlSubsampling_structure_ACN_Encode(codec: ACN, pVal: TSingleDiagnosticParameterReportForwardControlSubsampling, SingleDiagnosticParameterReportForwardControlSubsampling_n2: ULong, structure: TSingleDiagnosticParameterReportForwardControlSubsampling_structure): Either[Int, Int] = {
    ...
    SingleDiagnosticParameterReportForwardControlSubsampling_structure_Encode_loop(codec, structure, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def SingleDiagnosticParameterReportForwardControlSubsampling_structure_Decode_loop(codec: ACN, nCount: Int, structure: Vector[TDiagnosticParameterStructure_ID_ConfigurationSubsampling], i1: Int): EitherMut[Int, Vector[TDiagnosticParameterStructure_ID_ConfigurationSubsampling]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = SingleDiagnosticParameterReportForwardControlSubsampling_structure_Decode_loop(codec, nCount, structure.append(structure_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def SingleDiagnosticParameterReportForwardControlSubsampling_structure_ACN_Decode(codec: ACN, SingleDiagnosticParameterReportForwardControlSubsampling_n2: ULong): EitherMut[Int, TSingleDiagnosticParameterReportForwardControlSubsampling_structure] = {
    ...
    val structure =
        if ((SingleDiagnosticParameterReportForwardControlSubsampling_n2 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val structure = SingleDiagnosticParameterReportForwardControlSubsampling_structure_Decode_loop(codec, structure_nCount, Vector.empty[TDiagnosticParameterStructure_ID_ConfigurationSubsampling], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def DiagnosticParameterReportForwardControlSubsampling_forwardControl_Encode_loop(codec: ACN, forwardControl: TDiagnosticParameterReportForwardControlSubsampling_forwardControl, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == forwardControl.nCount) {
        ...
        val res = DiagnosticParameterReportForwardControlSubsampling_forwardControl_Encode_loop(codec, forwardControl, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def DiagnosticParameterReportForwardControlSubsampling_forwardControl_ACN_Encode(codec: ACN, pVal: TDiagnosticParameterReportForwardControlSubsampling, DiagnosticParameterReportForwardControlSubsampling_n1: ULong, forwardControl: TDiagnosticParameterReportForwardControlSubsampling_forwardControl): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    DiagnosticParameterReportForwardControlSubsampling_forwardControl_Encode_loop(codec, forwardControl, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def DiagnosticParameterReportForwardControlSubsampling_forwardControl_Decode_loop(codec: ACN, nCount: Int, forwardControl: Vector[TSingleDiagnosticParameterReportForwardControlSubsampling], i1: Int): EitherMut[Int, Vector[TSingleDiagnosticParameterReportForwardControlSubsampling]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = DiagnosticParameterReportForwardControlSubsampling_forwardControl_Decode_loop(codec, nCount, forwardControl.append(forwardControl_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def DiagnosticParameterReportForwardControlSubsampling_forwardControl_ACN_Decode(codec: ACN, DiagnosticParameterReportForwardControlSubsampling_n1: ULong): EitherMut[Int, TDiagnosticParameterReportForwardControlSubsampling_forwardControl] = {
    ...
    val forwardControl =
        if ((ULong.fromRaw(1) <= DiagnosticParameterReportForwardControlSubsampling_n1) && (DiagnosticParameterReportForwardControlSubsampling_n1 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val forwardControl = DiagnosticParameterReportForwardControlSubsampling_forwardControl_Decode_loop(codec, forwardControl_nCount, Vector.empty[TSingleDiagnosticParameterReportForwardControlSubsampling], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_Encode_loop(codec: ACN, structure: TSingleDiagnosticParameterReportForwardControlNoSubsampling_structure, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= structure.nCount))
    require((0 <= structure.nCount) && (structure.nCount <= structure.arr.size) && (structure.arr.size <= 31))
    require(codec.base.bitStream.validate_offset_bits((32L * (structure.nCount - i1))))
    decreases(structure.nCount - i1)
    if (i1 == structure.nCount) {
        ...
        val res = SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_Encode_loop(codec, structure, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_ACN_Encode(codec: ACN, pVal: TSingleDiagnosticParameterReportForwardControlNoSubsampling, SingleDiagnosticParameterReportForwardControlNoSubsampling_n2: ULong, structure: TSingleDiagnosticParameterReportForwardControlNoSubsampling_structure): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_Encode_loop(codec, structure, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_Decode_loop(codec: ACN, nCount: Int, structure: Vector[TDiagnosticParameterStructure_ID_ConfigurationNoSubsampling], i1: Int): EitherMut[Int, Vector[TDiagnosticParameterStructure_ID_ConfigurationNoSubsampling]] = {
    require((0 <= nCount) && (nCount <= 31))
    require((0 <= i1) && (i1 <= nCount))
    require(structure.size == i1)
    require(codec.base.bitStream.validate_offset_bits((32L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_Decode_loop(codec, nCount, structure.append(structure_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_ACN_Decode(codec: ACN, SingleDiagnosticParameterReportForwardControlNoSubsampling_n2: ULong): EitherMut[Int, TSingleDiagnosticParameterReportForwardControlNoSubsampling_structure] = {
    ...
    val structure =
        if ((SingleDiagnosticParameterReportForwardControlNoSubsampling_n2 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val structure = SingleDiagnosticParameterReportForwardControlNoSubsampling_structure_Decode_loop(codec, structure_nCount, Vector.empty[TDiagnosticParameterStructure_ID_ConfigurationNoSubsampling], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_Encode_loop(codec: ACN, forwardControl: TDiagnosticParameterReportForwardControlNoSubsampling_forwardControl, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= forwardControl.nCount))
    require((1 <= forwardControl.nCount) && (forwardControl.nCount <= forwardControl.arr.size) && (forwardControl.arr.size <= 31))
    require(codec.base.bitStream.validate_offset_bits((1035L * (forwardControl.nCount - i1))))
    decreases(forwardControl.nCount - i1)
    if (i1 == forwardControl.nCount) {
        ...
        val res = DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_Encode_loop(codec, forwardControl, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_ACN_Encode(codec: ACN, pVal: TDiagnosticParameterReportForwardControlNoSubsampling, DiagnosticParameterReportForwardControlNoSubsampling_n1: ULong, forwardControl: TDiagnosticParameterReportForwardControlNoSubsampling_forwardControl): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_Encode_loop(codec, forwardControl, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_Decode_loop(codec: ACN, nCount: Int, forwardControl: Vector[TSingleDiagnosticParameterReportForwardControlNoSubsampling], i1: Int): EitherMut[Int, Vector[TSingleDiagnosticParameterReportForwardControlNoSubsampling]] = {
    require((1 <= nCount) && (nCount <= 31))
    require((0 <= i1) && (i1 <= nCount))
    require(forwardControl.size == i1)
    require(codec.base.bitStream.validate_offset_bits((1035L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_Decode_loop(codec, nCount, forwardControl.append(forwardControl_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_ACN_Decode(codec: ACN, DiagnosticParameterReportForwardControlNoSubsampling_n1: ULong): EitherMut[Int, TDiagnosticParameterReportForwardControlNoSubsampling_forwardControl] = {
    ...
    val forwardControl =
        if ((ULong.fromRaw(1) <= DiagnosticParameterReportForwardControlNoSubsampling_n1) && (DiagnosticParameterReportForwardControlNoSubsampling_n1 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val forwardControl = DiagnosticParameterReportForwardControlNoSubsampling_forwardControl_Decode_loop(codec, forwardControl_nCount, Vector.empty[TSingleDiagnosticParameterReportForwardControlNoSubsampling], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
