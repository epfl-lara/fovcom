...
def TTM_6_6_DumpedRawMemoryDataReport_ACN_Encode(pVal: TTM_6_6_DumpedRawMemoryDataReport, codec: ACN, bCheckConstraints: Boolean): Either[ErrorCode, Int] =  // acn:21
{
    ...
    @ghost val codec_0_3 = snapshot(codec)
    /* Encode dataDumps */
    TM_6_6_DumpedRawMemoryDataReport_dataDumps_ACN_Encode(codec, pVal, TM_6_6_DumpedRawMemoryDataReport_n, pVal.dataDumps) match {
        case Left(l) =>
            return Left(l)
        case Right(_) =>
            ()
...
@opaque @inlineOnce
def TM_6_6_DumpedRawMemoryDataReport_dataDumps_Encode_loop(codec: ACN, dataDumps: TTM_6_6_DumpedRawMemoryDataReport_dataDumps, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= dataDumps.nCount))
    require((1 <= dataDumps.nCount) && (dataDumps.nCount <= dataDumps.arr.size) && (dataDumps.arr.size <= 63))
    ...
    if (i1 == dataDumps.nCount) {
        ...
        val res = TM_6_6_DumpedRawMemoryDataReport_dataDumps_Encode_loop(codec, dataDumps, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
                case Right(_) =>
                    ...
                    assert(codecSnap2.base.bitStream.bitIndex == codecSnap1.base.bitStream.bitIndex + dataDumps.arr.apply(i1).size(codecSnap1.base.bitStream.bitIndex))
                    assert(TTM_6_6_DumpedRawMemoryDataReport_dataDumps.sizeRange(dataDumps.arr, codecSnap1.base.bitStream.bitIndex, i1, dataDumps.nCount) == dataDumps.arr.apply(i1).size(codecSnap1.base.bitStream.bitIndex) + TTM_6_6_DumpedRawMemoryDataReport_dataDumps.sizeRange(dataDumps.arr, codecSnap2.base.bitStream.bitIndex, i1 + 1, dataDumps.nCount))
...
@opaque @inlineOnce
def TM_6_6_DumpedRawMemoryDataReport_dataDumps_ACN_Encode(codec: ACN, pVal: TTM_6_6_DumpedRawMemoryDataReport, TM_6_6_DumpedRawMemoryDataReport_n: ULong, dataDumps: TTM_6_6_DumpedRawMemoryDataReport_dataDumps): Either[Int, Int] = {
    ...
    TM_6_6_DumpedRawMemoryDataReport_dataDumps_Encode_loop(codec, dataDumps, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TM_6_6_DumpedRawMemoryDataReport_dataDumps_Decode_loop(codec: ACN, nCount: Int, dataDumps: Vector[TDataDump], i1: Int): EitherMut[Int, Vector[TDataDump]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TM_6_6_DumpedRawMemoryDataReport_dataDumps_Decode_loop(codec, nCount, dataDumps.append(dataDumps_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_6_6_DumpedRawMemoryDataReport_dataDumps_ACN_Decode(codec: ACN, TM_6_6_DumpedRawMemoryDataReport_n: ULong): EitherMut[Int, TTM_6_6_DumpedRawMemoryDataReport_dataDumps] = {
    ...
    val dataDumps =
        if ((ULong.fromRaw(1) <= TM_6_6_DumpedRawMemoryDataReport_n) && (TM_6_6_DumpedRawMemoryDataReport_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val dataDumps = TM_6_6_DumpedRawMemoryDataReport_dataDumps_Decode_loop(codec, dataDumps_nCount, Vector.empty[TDataDump], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@ghost @pure
def TM_6_6_DumpedRawMemoryDataReport_dataDumps_ACN_Decode_pure(codec: ACN, TM_6_6_DumpedRawMemoryDataReport_n: ULong): (ACN, EitherMut[Int, TTM_6_6_DumpedRawMemoryDataReport_dataDumps]) = {
    require(codec.base.bitStream.validate_offset_bits(2068983L))
    val cpy = snapshot(codec)
    val res = TM_6_6_DumpedRawMemoryDataReport_dataDumps_ACN_Decode(cpy, TM_6_6_DumpedRawMemoryDataReport_n)
    (cpy, res)
}