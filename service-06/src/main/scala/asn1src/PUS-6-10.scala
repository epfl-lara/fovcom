...
@opaque @inlineOnce
def TM_6_10_CheckedRawMemoryDartaReport_dataArea_Encode_loop(codec: ACN, dataArea: TTM_6_10_CheckedRawMemoryDartaReport_dataArea, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == dataArea.nCount) {
        ...
        val res = TM_6_10_CheckedRawMemoryDartaReport_dataArea_Encode_loop(codec, dataArea, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_6_10_CheckedRawMemoryDartaReport_dataArea_ACN_Encode(codec: ACN, pVal: TTM_6_10_CheckedRawMemoryDartaReport, TM_6_10_CheckedRawMemoryDartaReport_n: ULong, dataArea: TTM_6_10_CheckedRawMemoryDartaReport_dataArea): Either[Int, Int] = {
    ...
    TM_6_10_CheckedRawMemoryDartaReport_dataArea_Encode_loop(codec, dataArea, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TM_6_10_CheckedRawMemoryDartaReport_dataArea_Decode_loop(codec: ACN, nCount: Int, dataArea: Vector[TTM_6_10_DataArea], i1: Int): EitherMut[Int, Vector[TTM_6_10_DataArea]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TM_6_10_CheckedRawMemoryDartaReport_dataArea_Decode_loop(codec, nCount, dataArea.append(dataArea_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_6_10_CheckedRawMemoryDartaReport_dataArea_ACN_Decode(codec: ACN, TM_6_10_CheckedRawMemoryDartaReport_n: ULong): EitherMut[Int, TTM_6_10_CheckedRawMemoryDartaReport_dataArea] = {
    ...
    val dataArea =
        if ((ULong.fromRaw(1) <= TM_6_10_CheckedRawMemoryDartaReport_n) && (TM_6_10_CheckedRawMemoryDartaReport_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val dataArea = TM_6_10_CheckedRawMemoryDartaReport_dataArea_Decode_loop(codec, dataArea_nCount, Vector.empty[TTM_6_10_DataArea], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
