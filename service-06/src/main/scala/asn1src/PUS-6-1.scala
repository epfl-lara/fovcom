...
@opaque @inlineOnce
def TC_6_1_LoadObjectMemoryData_loadObjectInstructions_Encode_loop(codec: ACN, loadObjectInstructions: TTC_6_1_LoadObjectMemoryData_loadObjectInstructions, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == loadObjectInstructions.nCount) {
        ...
        val res = TC_6_1_LoadObjectMemoryData_loadObjectInstructions_Encode_loop(codec, loadObjectInstructions, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_6_1_LoadObjectMemoryData_loadObjectInstructions_ACN_Encode(codec: ACN, pVal: TTC_6_1_LoadObjectMemoryData, TC_6_1_LoadObjectMemoryData_n: ULong, loadObjectInstructions: TTC_6_1_LoadObjectMemoryData_loadObjectInstructions): Either[Int, Int] = {
    ...
    TC_6_1_LoadObjectMemoryData_loadObjectInstructions_Encode_loop(codec, loadObjectInstructions, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_6_1_LoadObjectMemoryData_loadObjectInstructions_Decode_loop(codec: ACN, nCount: Int, loadObjectInstructions: Vector[TLoadObjectInstruction], i1: Int): EitherMut[Int, Vector[TLoadObjectInstruction]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_6_1_LoadObjectMemoryData_loadObjectInstructions_Decode_loop(codec, nCount, loadObjectInstructions.append(loadObjectInstructions_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_6_1_LoadObjectMemoryData_loadObjectInstructions_ACN_Decode(codec: ACN, TC_6_1_LoadObjectMemoryData_n: ULong): EitherMut[Int, TTC_6_1_LoadObjectMemoryData_loadObjectInstructions] = {
    ...
    val loadObjectInstructions =
        if ((ULong.fromRaw(1) <= TC_6_1_LoadObjectMemoryData_n) && (TC_6_1_LoadObjectMemoryData_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val loadObjectInstructions = TC_6_1_LoadObjectMemoryData_loadObjectInstructions_Decode_loop(codec, loadObjectInstructions_nCount, Vector.empty[TLoadObjectInstruction], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_Encode_loop(codec: ACN, loadObjectInstructions: TTC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= loadObjectInstructions.nCount))
    require((1 <= loadObjectInstructions.nCount) && (loadObjectInstructions.nCount <= loadObjectInstructions.arr.size) && (loadObjectInstructions.arr.size <= 63))
    require(codec.base.bitStream.validate_offset_bits((32840L * (loadObjectInstructions.nCount - i1))))
    decreases(loadObjectInstructions.nCount - i1)
    if (i1 == loadObjectInstructions.nCount) {
        ...
        val res = TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_Encode_loop(codec, loadObjectInstructions, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_ACN_Encode(codec: ACN, pVal: TTC_6_1_LoadObjectMemoryDataMultipleMemid, TC_6_1_LoadObjectMemoryDataMultipleMemid_n: ULong, loadObjectInstructions: TTC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_Encode_loop(codec, loadObjectInstructions, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_Decode_loop(codec: ACN, nCount: Int, loadObjectInstructions: Vector[TLoadObjectInstruction], i1: Int): EitherMut[Int, Vector[TLoadObjectInstruction]] = {
    require((1 <= nCount) && (nCount <= 63))
    require((0 <= i1) && (i1 <= nCount))
    require(loadObjectInstructions.size == i1)
    require(codec.base.bitStream.validate_offset_bits((32840L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_Decode_loop(codec, nCount, loadObjectInstructions.append(loadObjectInstructions_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_ACN_Decode(codec: ACN, TC_6_1_LoadObjectMemoryDataMultipleMemid_n: ULong): EitherMut[Int, TTC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions] = {
    ...
    val loadObjectInstructions =
        if ((ULong.fromRaw(1) <= TC_6_1_LoadObjectMemoryDataMultipleMemid_n) && (TC_6_1_LoadObjectMemoryDataMultipleMemid_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val loadObjectInstructions = TC_6_1_LoadObjectMemoryDataMultipleMemid_loadObjectInstructions_Decode_loop(codec, loadObjectInstructions_nCount, Vector.empty[TLoadObjectInstruction], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
