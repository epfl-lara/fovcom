...
@inline @cCode.inline val ERR_PARAMETER_ID: Int = 950 /*param1 */

 

@inline @cCode.inline val ERR_ACN_ENCODE_PARAMETER_ID: Int = 953 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_PARAMETER_ID: Int = 954 /*  */
/*-- TParameterValue --------------------------------------------*/
...
@inline @cCode.inline val ERR_PARAMETERVALUE_PARAM1: Int = 955 /*(0 ..255) */

@inline @cCode.inline val ERR_PARAMETERVALUE: Int = 960 /* */
...
@inline @cCode.inline val ERR_PARAMETERMASK_PARAM1: Int = 965 /*(SIZE (16)) */

@inline @cCode.inline val ERR_PARAMETERMASK: Int = 970 /* */
