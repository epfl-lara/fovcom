...
@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 925 /*(0 .. 4294967295) */

 

@inline @cCode.inline val ERR_ACN_ENCODE_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 928 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 929 /*  */
...
@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERVALUES_STRUCT1: Int = 930 /*(0 .. 255) */

@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERVALUES: Int = 935 /* */
