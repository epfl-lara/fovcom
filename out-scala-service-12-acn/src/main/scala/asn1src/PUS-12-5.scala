...
@opaque @inlineOnce
def PUS_12_5_TTC_12_5_AddParameterMonitoringDefinitions_definitions_pVal_definitions_definitions_Encode_loop(codec: ACN, definitions: TTC_12_5_AddParameterMonitoringDefinitions_definitions, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == definitions.nCount) {
        ...
        val res = PUS_12_5_TTC_12_5_AddParameterMonitoringDefinitions_definitions_pVal_definitions_definitions_Encode_loop(codec, definitions, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_12_5_AddParameterMonitoringDefinitions_definitions_ACN_Encode(codec: ACN, pVal: TTC_12_5_AddParameterMonitoringDefinitions, TC_12_5_AddParameterMonitoringDefinitions_n: ULong, definitions: TTC_12_5_AddParameterMonitoringDefinitions_definitions): Either[Int, Int] = {
    ...
    PUS_12_5_TTC_12_5_AddParameterMonitoringDefinitions_definitions_pVal_definitions_definitions_Encode_loop(codec, definitions, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_12_5_TTC_12_5_AddParameterMonitoringDefinitions_definitions_pVal_definitions_definitions_Decode_loop(codec: ACN, nCount: Int, definitions: Vector[TParameterMonitoringDefinition], i1: Int): EitherMut[Int, Vector[TParameterMonitoringDefinition]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_12_5_TTC_12_5_AddParameterMonitoringDefinitions_definitions_pVal_definitions_definitions_Decode_loop(codec, nCount, definitions.append(definitions_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_12_5_AddParameterMonitoringDefinitions_definitions_ACN_Decode(codec: ACN, TC_12_5_AddParameterMonitoringDefinitions_n: ULong): EitherMut[Int, TTC_12_5_AddParameterMonitoringDefinitions_definitions] = {
    ...
    val definitions =
        if ((ULong.fromRaw(1) <= TC_12_5_AddParameterMonitoringDefinitions_n) && (TC_12_5_AddParameterMonitoringDefinitions_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val definitions = PUS_12_5_TTC_12_5_AddParameterMonitoringDefinitions_definitions_pVal_definitions_definitions_Decode_loop(codec, definitions_nCount, Vector.empty[TParameterMonitoringDefinition], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
