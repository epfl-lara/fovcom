...
@opaque @inlineOnce
def PUS_12_28_TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_pVal_statusReport_statusReport_Encode_loop(codec: ACN, statusReport: TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == statusReport.nCount) {
        ...
        val res = PUS_12_28_TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_pVal_statusReport_statusReport_Encode_loop(codec, statusReport, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_ACN_Encode(codec: ACN, pVal: TTM_12_28_FunctionalMonitoringDefinitionStatusReport, TM_12_28_FunctionalMonitoringDefinitionStatusReport_n: ULong, statusReport: TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport): Either[Int, Int] = {
    ...
    PUS_12_28_TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_pVal_statusReport_statusReport_Encode_loop(codec, statusReport, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_12_28_TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_pVal_statusReport_statusReport_Decode_loop(codec: ACN, nCount: Int, statusReport: Vector[TTM_12_28_StatusReport], i1: Int): EitherMut[Int, Vector[TTM_12_28_StatusReport]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_12_28_TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_pVal_statusReport_statusReport_Decode_loop(codec, nCount, statusReport.append(statusReport_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_ACN_Decode(codec: ACN, TM_12_28_FunctionalMonitoringDefinitionStatusReport_n: ULong): EitherMut[Int, TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport] = {
    ...
    val statusReport =
        if ((ULong.fromRaw(1) <= TM_12_28_FunctionalMonitoringDefinitionStatusReport_n) && (TM_12_28_FunctionalMonitoringDefinitionStatusReport_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val statusReport = PUS_12_28_TTM_12_28_FunctionalMonitoringDefinitionStatusReport_statusReport_pVal_statusReport_statusReport_Decode_loop(codec, statusReport_nCount, Vector.empty[TTM_12_28_StatusReport], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
