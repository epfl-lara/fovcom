...
@opaque @inlineOnce
def PUS_12_26_TTM_12_28_MonitoringDefinitionReport_pmon_ID_pVal_pmon_ID_pmon_ID_Encode_loop(codec: ACN, pmon_ID: TTM_12_28_MonitoringDefinitionReport_pmon_ID, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == pmon_ID.nCount) {
        ...
        val res = PUS_12_26_TTM_12_28_MonitoringDefinitionReport_pmon_ID_pVal_pmon_ID_pmon_ID_Encode_loop(codec, pmon_ID, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_12_28_MonitoringDefinitionReport_pmon_ID_ACN_Encode(codec: ACN, pVal: TTM_12_28_MonitoringDefinitionReport, TM_12_28_MonitoringDefinitionReport_n2: ULong, pmon_ID: TTM_12_28_MonitoringDefinitionReport_pmon_ID): Either[Int, Int] = {
    ...
    PUS_12_26_TTM_12_28_MonitoringDefinitionReport_pmon_ID_pVal_pmon_ID_pmon_ID_Encode_loop(codec, pmon_ID, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_12_26_TTM_12_28_MonitoringDefinitionReport_pmon_ID_pVal_pmon_ID_pmon_ID_Decode_loop(codec: ACN, nCount: Int, pmon_ID: Vector[TPMON_ID], i1: Int): EitherMut[Int, Vector[TPMON_ID]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_12_26_TTM_12_28_MonitoringDefinitionReport_pmon_ID_pVal_pmon_ID_pmon_ID_Decode_loop(codec, nCount, pmon_ID.append(pmon_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_12_28_MonitoringDefinitionReport_pmon_ID_ACN_Decode(codec: ACN, TM_12_28_MonitoringDefinitionReport_n2: ULong): EitherMut[Int, TTM_12_28_MonitoringDefinitionReport_pmon_ID] = {
    ...
    val pmon_ID =
        if ((ULong.fromRaw(1) <= TM_12_28_MonitoringDefinitionReport_n2) && (TM_12_28_MonitoringDefinitionReport_n2 <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val pmon_ID = PUS_12_26_TTM_12_28_MonitoringDefinitionReport_pmon_ID_pVal_pmon_ID_pmon_ID_Decode_loop(codec, pmon_ID_nCount, Vector.empty[TPMON_ID], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def PUS_12_26_TTM_12_28_FunctionalMonitoringDefinitionReport_report_pVal_report_report_Encode_loop(codec: ACN, report: TTM_12_28_FunctionalMonitoringDefinitionReport_report, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == report.nCount) {
        ...
        val res = PUS_12_26_TTM_12_28_FunctionalMonitoringDefinitionReport_report_pVal_report_report_Encode_loop(codec, report, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_12_28_FunctionalMonitoringDefinitionReport_report_ACN_Encode(codec: ACN, pVal: TTM_12_28_FunctionalMonitoringDefinitionReport, TM_12_28_FunctionalMonitoringDefinitionReport_n1: ULong, report: TTM_12_28_FunctionalMonitoringDefinitionReport_report): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    PUS_12_26_TTM_12_28_FunctionalMonitoringDefinitionReport_report_pVal_report_report_Encode_loop(codec, report, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_12_26_TTM_12_28_FunctionalMonitoringDefinitionReport_report_pVal_report_report_Decode_loop(codec: ACN, nCount: Int, report: Vector[TTM_12_28_MonitoringDefinitionReport], i1: Int): EitherMut[Int, Vector[TTM_12_28_MonitoringDefinitionReport]] = {
    require((1 <= nCount) && (nCount <= 4095))
    require((0 <= i1) && (i1 <= nCount))
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_12_26_TTM_12_28_FunctionalMonitoringDefinitionReport_report_pVal_report_report_Decode_loop(codec, nCount, report.append(report_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_12_28_FunctionalMonitoringDefinitionReport_report_ACN_Decode(codec: ACN, TM_12_28_FunctionalMonitoringDefinitionReport_n1: ULong): EitherMut[Int, TTM_12_28_FunctionalMonitoringDefinitionReport_report] = {
    ...
    val report =
        if ((ULong.fromRaw(1) <= TM_12_28_FunctionalMonitoringDefinitionReport_n1) && (TM_12_28_FunctionalMonitoringDefinitionReport_n1 <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val report = PUS_12_26_TTM_12_28_FunctionalMonitoringDefinitionReport_report_pVal_report_report_Decode_loop(codec, report_nCount, Vector.empty[TTM_12_28_MonitoringDefinitionReport], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
