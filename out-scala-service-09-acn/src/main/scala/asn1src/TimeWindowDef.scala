...
@inline @cCode.inline val ERR_TIMEWINDOWTYPE: Int = 1057 /*selectAll | fromTimeTagToTimeTag | fromTimeTag | toTimeTag */

 

@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOWTYPE: Int = 1060 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOWTYPE: Int = 1061 /*  */
/*-- TTimeTags --------------------------------------------*/
...
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 987 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 952 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 982 /* */

@inline @cCode.inline val ERR_TIMETAGS: Int = 1052 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAG_2_2: Int = 1017 /* */
@inline @cCode.inline val ERR_TIMETAGS_TOTIMETAG_2_2: Int = 1047 /* */
...
@inline @cCode.inline val ERR_TIMEWINDOW: Int = 917 /* */
@inline @cCode.inline val ERR_TIMEWINDOW_TIMETAGS_2: Int = 914 /* */

 

@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW: Int = 920 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TYPE_UNINITIALIZED: Int = 921 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TYPE: Int = 778 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS: Int = 912 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 847 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 812 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 842 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAG_2_2: Int = 877 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_TOTIMETAG_2_2: Int = 907 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW: Int = 922 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TYPE: Int = 779 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS: Int = 913 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 848 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 813 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 843 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAG_2_2: Int = 878 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_TOTIMETAG_2_2: Int = 908 /*  */
