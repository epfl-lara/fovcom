...
@inline @cCode.inline val ERR_PARAMETER_ID: Int = 601 /*param1 */

 

@inline @cCode.inline val ERR_ACN_ENCODE_PARAMETER_ID: Int = 604 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_PARAMETER_ID: Int = 605 /*  */
/*-- TParameterValue --------------------------------------------*/
...
@inline @cCode.inline val ERR_PARAMETERVALUE_PARAM1: Int = 606 /*(0 ..255) */

@inline @cCode.inline val ERR_PARAMETERVALUE: Int = 611 /* */
...
@inline @cCode.inline val ERR_PARAMETERMASK_PARAM1: Int = 616 /*(SIZE (16)) */

@inline @cCode.inline val ERR_PARAMETERMASK: Int = 621 /* */
