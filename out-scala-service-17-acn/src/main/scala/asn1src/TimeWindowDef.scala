...
@inline @cCode.inline val ERR_TIMEWINDOWTYPE: Int = 945 /*selectAll | fromTimeTagToTimeTag | fromTimeTag | toTimeTag */

 

@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOWTYPE: Int = 948 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOWTYPE: Int = 949 /*  */
/*-- TTimeTags --------------------------------------------*/
...
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 875 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 840 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 870 /* */

@inline @cCode.inline val ERR_TIMETAGS: Int = 940 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAG_2_2: Int = 905 /* */
@inline @cCode.inline val ERR_TIMETAGS_TOTIMETAG_2_2: Int = 935 /* */
...
@inline @cCode.inline val ERR_TIMEWINDOW: Int = 805 /* */
@inline @cCode.inline val ERR_TIMEWINDOW_TIMETAGS_2: Int = 802 /* */

 

@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW: Int = 808 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TYPE_UNINITIALIZED: Int = 809 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TYPE: Int = 666 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS: Int = 800 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 735 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 700 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 730 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAG_2_2: Int = 765 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_TOTIMETAG_2_2: Int = 795 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW: Int = 810 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TYPE: Int = 667 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS: Int = 801 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 736 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 701 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 731 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAG_2_2: Int = 766 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_TOTIMETAG_2_2: Int = 796 /*  */
