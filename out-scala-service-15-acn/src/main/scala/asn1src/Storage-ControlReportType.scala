...
@opaque @inlineOnce
def Storage_ControlReportType_TStorage_ControlReportTypeMessageSubtypes_messageSubtype_pVal_messageSubtype_messageSubtype_Encode_loop(codec: ACN, messageSubtype: TStorage_ControlReportTypeMessageSubtypes_messageSubtype, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == messageSubtype.nCount) {
        ...
        val res = Storage_ControlReportType_TStorage_ControlReportTypeMessageSubtypes_messageSubtype_pVal_messageSubtype_messageSubtype_Encode_loop(codec, messageSubtype, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def Storage_ControlReportTypeMessageSubtypes_messageSubtype_ACN_Encode(codec: ACN, pVal: TStorage_ControlReportTypeMessageSubtypes, Storage_ControlReportTypeMessageSubtypes_n3: ULong, messageSubtype: TStorage_ControlReportTypeMessageSubtypes_messageSubtype): Either[Int, Int] = {
    ...
    Storage_ControlReportType_TStorage_ControlReportTypeMessageSubtypes_messageSubtype_pVal_messageSubtype_messageSubtype_Encode_loop(codec, messageSubtype, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def Storage_ControlReportType_TStorage_ControlReportTypeMessageSubtypes_messageSubtype_pVal_messageSubtype_messageSubtype_Decode_loop(codec: ACN, nCount: Int, messageSubtype: Vector[ULong], i1: Int): EitherMut[Int, Vector[ULong]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = Storage_ControlReportType_TStorage_ControlReportTypeMessageSubtypes_messageSubtype_pVal_messageSubtype_messageSubtype_Decode_loop(codec, nCount, messageSubtype.append(messageSubtype_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def Storage_ControlReportTypeMessageSubtypes_messageSubtype_ACN_Decode(codec: ACN, Storage_ControlReportTypeMessageSubtypes_n3: ULong): EitherMut[Int, TStorage_ControlReportTypeMessageSubtypes_messageSubtype] = {
    ...
    val messageSubtype =
        if ((Storage_ControlReportTypeMessageSubtypes_n3 <= ULong.fromRaw(32))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val messageSubtype = Storage_ControlReportType_TStorage_ControlReportTypeMessageSubtypes_messageSubtype_pVal_messageSubtype_messageSubtype_Decode_loop(codec, messageSubtype_nCount, Vector.empty[ULong], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def Storage_ControlReportType_TStorage_ControlReportTypeStorage_ControlConfiguration_tail_pVal_tail_tail_Encode_loop(codec: ACN, tail: TStorage_ControlReportTypeStorage_ControlConfiguration_tail, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == tail.nCount) {
        ...
        val res = Storage_ControlReportType_TStorage_ControlReportTypeStorage_ControlConfiguration_tail_pVal_tail_tail_Encode_loop(codec, tail, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def Storage_ControlReportTypeStorage_ControlConfiguration_tail_ACN_Encode(codec: ACN, pVal: TStorage_ControlReportTypeStorage_ControlConfiguration, Storage_ControlReportTypeStorage_ControlConfiguration_n2: ULong, tail: TStorage_ControlReportTypeStorage_ControlConfiguration_tail): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    Storage_ControlReportType_TStorage_ControlReportTypeStorage_ControlConfiguration_tail_pVal_tail_tail_Encode_loop(codec, tail, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def Storage_ControlReportType_TStorage_ControlReportTypeStorage_ControlConfiguration_tail_pVal_tail_tail_Decode_loop(codec: ACN, nCount: Int, tail: Vector[TStorage_ControlReportTypeMessageSubtypes], i1: Int): EitherMut[Int, Vector[TStorage_ControlReportTypeMessageSubtypes]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = Storage_ControlReportType_TStorage_ControlReportTypeStorage_ControlConfiguration_tail_pVal_tail_tail_Decode_loop(codec, nCount, tail.append(tail_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def Storage_ControlReportTypeStorage_ControlConfiguration_tail_ACN_Decode(codec: ACN, Storage_ControlReportTypeStorage_ControlConfiguration_n2: ULong): EitherMut[Int, TStorage_ControlReportTypeStorage_ControlConfiguration_tail] = {
    ...
    val tail =
        if ((Storage_ControlReportTypeStorage_ControlConfiguration_n2 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val tail = Storage_ControlReportType_TStorage_ControlReportTypeStorage_ControlConfiguration_tail_pVal_tail_tail_Decode_loop(codec, tail_nCount, Vector.empty[TStorage_ControlReportTypeMessageSubtypes], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def Storage_ControlReportType_TStorage_ControlReportType_configuration_pVal_configuration_configuration_Encode_loop(codec: ACN, configuration: TStorage_ControlReportType_configuration, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == configuration.nCount) {
        ...
        val res = Storage_ControlReportType_TStorage_ControlReportType_configuration_pVal_configuration_configuration_Encode_loop(codec, configuration, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def Storage_ControlReportType_configuration_ACN_Encode(codec: ACN, pVal: TStorage_ControlReportType, Storage_ControlReportType_n1: ULong, configuration: TStorage_ControlReportType_configuration): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    Storage_ControlReportType_TStorage_ControlReportType_configuration_pVal_configuration_configuration_Encode_loop(codec, configuration, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def Storage_ControlReportType_TStorage_ControlReportType_configuration_pVal_configuration_configuration_Decode_loop(codec: ACN, nCount: Int, configuration: Vector[TStorage_ControlReportTypeStorage_ControlConfiguration], i1: Int): EitherMut[Int, Vector[TStorage_ControlReportTypeStorage_ControlConfiguration]] = {
    require((0 <= nCount) && (nCount <= 31))
    require((0 <= i1) && (i1 <= nCount))
    ...
    (if (i1 == nCount) {
        ...
        val res = Storage_ControlReportType_TStorage_ControlReportType_configuration_pVal_configuration_configuration_Decode_loop(codec, nCount, configuration.append(configuration_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def Storage_ControlReportType_configuration_ACN_Decode(codec: ACN, Storage_ControlReportType_n1: ULong): EitherMut[Int, TStorage_ControlReportType_configuration] = {
    ...
    val configuration =
        if ((Storage_ControlReportType_n1 <= ULong.fromRaw(31))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val configuration = Storage_ControlReportType_TStorage_ControlReportType_configuration_pVal_configuration_configuration_Decode_loop(codec, configuration_nCount, Vector.empty[TStorage_ControlReportTypeStorage_ControlConfiguration], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
