...
def TPacketStore_ID_ACN_Encode(pVal: TPacketStore_ID, codec: ACN, bCheckConstraints: Boolean): Either[ErrorCode, Int] =  // acn:21
{
    ...
    PacketStore_TPacketStore_ID_pVal_Encode_loop(codec, pVal, 0) match {
        case Left(l) =>
...
@opaque @inlineOnce
def PacketStore_TPacketStore_ID_pVal_Encode_loop(codec: ACN, pVal: Vector[UByte], i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= 32))
    ...
    if (i1 == 32) {
        ...
        val res = PacketStore_TPacketStore_ID_pVal_Encode_loop(codec, pVal, i1 + 1)
        res
    }
...
def TPacketStore_ID_ACN_Decode(codec: ACN): EitherMut[ErrorCode, TPacketStore_ID] =
{
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    val pVal = PacketStore_TPacketStore_ID_pVal_Decode_loop(codec, Vector.empty[UByte], 0) match {
        case LeftMut(l) =>
            return LeftMut(l)
        case RightMut(bdg) =>
            bdg
...
@opaque @inlineOnce
def PacketStore_TPacketStore_ID_pVal_Decode_loop(codec: ACN, pVal: Vector[UByte], i1: Int): EitherMut[Int, Vector[UByte]] = {
    require((0 <= i1) && (i1 <= 32))
    ...
    (if (i1 == 32) {
        ...
        val res = PacketStore_TPacketStore_ID_pVal_Decode_loop(codec, pVal.append(pVal_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
@opaque @inlineOnce
def PacketStore_TPacketStoreSequence_packetStores_pVal_packetStores_packetStores_Encode_loop(codec: ACN, packetStores: TPacketStoreSequence_packetStores, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == packetStores.nCount) {
        ...
        val res = PacketStore_TPacketStoreSequence_packetStores_pVal_packetStores_packetStores_Encode_loop(codec, packetStores, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def PacketStoreSequence_packetStores_ACN_Encode(codec: ACN, pVal: TPacketStoreSequence, PacketStoreSequence_n: ULong, packetStores: TPacketStoreSequence_packetStores): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    PacketStore_TPacketStoreSequence_packetStores_pVal_packetStores_packetStores_Encode_loop(codec, packetStores, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PacketStore_TPacketStoreSequence_packetStores_pVal_packetStores_packetStores_Decode_loop(codec: ACN, nCount: Int, packetStores: Vector[Vector[UByte]], i1: Int): EitherMut[Int, Vector[Vector[UByte]]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PacketStore_TPacketStoreSequence_packetStores_pVal_packetStores_packetStores_Decode_loop(codec, nCount, packetStores.append(packetStores_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def PacketStoreSequence_packetStores_ACN_Decode(codec: ACN, PacketStoreSequence_n: ULong): EitherMut[Int, TPacketStoreSequence_packetStores] = {
    ...
    val packetStores =
        if ((ULong.fromRaw(1) <= PacketStoreSequence_n) && (PacketStoreSequence_n <= ULong.fromRaw(32))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val packetStores = PacketStore_TPacketStoreSequence_packetStores_pVal_packetStores_packetStores_Decode_loop(codec, packetStores_nCount, Vector.empty[Vector[UByte]], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
