...
@opaque @inlineOnce
def PUS_18_18_TTM_18_18_AbortedOBCPReport_obcp_IDs_pVal_obcp_IDs_obcp_IDs_Encode_loop(codec: ACN, obcp_IDs: TTM_18_18_AbortedOBCPReport_obcp_IDs, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == obcp_IDs.nCount) {
        ...
        val res = PUS_18_18_TTM_18_18_AbortedOBCPReport_obcp_IDs_pVal_obcp_IDs_obcp_IDs_Encode_loop(codec, obcp_IDs, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_18_18_AbortedOBCPReport_obcp_IDs_ACN_Encode(codec: ACN, pVal: TTM_18_18_AbortedOBCPReport, TM_18_18_AbortedOBCPReport_n: ULong, obcp_IDs: TTM_18_18_AbortedOBCPReport_obcp_IDs): Either[Int, Int] = {
    ...
    PUS_18_18_TTM_18_18_AbortedOBCPReport_obcp_IDs_pVal_obcp_IDs_obcp_IDs_Encode_loop(codec, obcp_IDs, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_18_18_TTM_18_18_AbortedOBCPReport_obcp_IDs_pVal_obcp_IDs_obcp_IDs_Decode_loop(codec: ACN, nCount: Int, obcp_IDs: Vector[Vector[UByte]], i1: Int): EitherMut[Int, Vector[Vector[UByte]]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_18_18_TTM_18_18_AbortedOBCPReport_obcp_IDs_pVal_obcp_IDs_obcp_IDs_Decode_loop(codec, nCount, obcp_IDs.append(obcp_IDs_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_18_18_AbortedOBCPReport_obcp_IDs_ACN_Decode(codec: ACN, TM_18_18_AbortedOBCPReport_n: ULong): EitherMut[Int, TTM_18_18_AbortedOBCPReport_obcp_IDs] = {
    ...
    val obcp_IDs =
        if ((ULong.fromRaw(1) <= TM_18_18_AbortedOBCPReport_n) && (TM_18_18_AbortedOBCPReport_n <= ULong.fromRaw(15))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val obcp_IDs = PUS_18_18_TTM_18_18_AbortedOBCPReport_obcp_IDs_pVal_obcp_IDs_obcp_IDs_Decode_loop(codec, obcp_IDs_nCount, Vector.empty[Vector[UByte]], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
