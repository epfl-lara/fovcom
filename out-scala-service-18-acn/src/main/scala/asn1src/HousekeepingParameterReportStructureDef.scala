...
@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 1221 /*(0 .. 4294967295) */

 

@inline @cCode.inline val ERR_ACN_ENCODE_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 1224 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_HOUSEKEEPINGPARAMETERREPORTSTRUCTURE_ID: Int = 1225 /*  */
...
@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERVALUES_STRUCT1: Int = 1226 /*(0 .. 255) */

@inline @cCode.inline val ERR_HOUSEKEEPINGPARAMETERVALUES: Int = 1231 /* */
