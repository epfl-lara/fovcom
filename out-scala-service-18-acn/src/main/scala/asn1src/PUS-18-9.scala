...
@opaque @inlineOnce
def PUS_18_9_TTM_18_9_OBCPExecutionStatusReport_executionStatueses_pVal_executionStatueses_executionStatueses_Encode_loop(codec: ACN, executionStatueses: TTM_18_9_OBCPExecutionStatusReport_executionStatueses, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == executionStatueses.nCount) {
        ...
        val res = PUS_18_9_TTM_18_9_OBCPExecutionStatusReport_executionStatueses_pVal_executionStatueses_executionStatueses_Encode_loop(codec, executionStatueses, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_18_9_OBCPExecutionStatusReport_executionStatueses_ACN_Encode(codec: ACN, pVal: TTM_18_9_OBCPExecutionStatusReport, TM_18_9_OBCPExecutionStatusReport_n: ULong, executionStatueses: TTM_18_9_OBCPExecutionStatusReport_executionStatueses): Either[Int, Int] = {
    ...
    PUS_18_9_TTM_18_9_OBCPExecutionStatusReport_executionStatueses_pVal_executionStatueses_executionStatueses_Encode_loop(codec, executionStatueses, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def PUS_18_9_TTM_18_9_OBCPExecutionStatusReport_executionStatueses_pVal_executionStatueses_executionStatueses_Decode_loop(codec: ACN, nCount: Int, executionStatueses: Vector[TTM_18_9_OBCPExecutionStatus], i1: Int): EitherMut[Int, Vector[TTM_18_9_OBCPExecutionStatus]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = PUS_18_9_TTM_18_9_OBCPExecutionStatusReport_executionStatueses_pVal_executionStatueses_executionStatueses_Decode_loop(codec, nCount, executionStatueses.append(executionStatueses_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_18_9_OBCPExecutionStatusReport_executionStatueses_ACN_Decode(codec: ACN, TM_18_9_OBCPExecutionStatusReport_n: ULong): EitherMut[Int, TTM_18_9_OBCPExecutionStatusReport_executionStatueses] = {
    ...
    val executionStatueses =
        if ((ULong.fromRaw(1) <= TM_18_9_OBCPExecutionStatusReport_n) && (TM_18_9_OBCPExecutionStatusReport_n <= ULong.fromRaw(15))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val executionStatueses = PUS_18_9_TTM_18_9_OBCPExecutionStatusReport_executionStatueses_pVal_executionStatueses_executionStatueses_Decode_loop(codec, executionStatueses_nCount, Vector.empty[TTM_18_9_OBCPExecutionStatus], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
