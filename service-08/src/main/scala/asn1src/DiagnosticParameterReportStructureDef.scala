...
@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 662 /*(0 .. 4294967295) */

 

@inline @cCode.inline val ERR_ACN_ENCODE_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 665 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_DIAGNOSTICPARAMETERREPORTSTRUCTURE_ID: Int = 666 /*  */
...
@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERVALUES_STRUCT1: Int = 667 /*(0 .. 255) */

@inline @cCode.inline val ERR_DIAGNOSTICPARAMETERVALUES: Int = 672 /* */
