...
def TFunction_ID_ACN_Encode(pVal: TFunction_ID, codec: ACN, bCheckConstraints: Boolean): Either[ErrorCode, Int] =  // acn:21
{
    ...
    Function_ID_Encode_loop(codec, pVal, 0) match {
        case Left(l) =>
...
@opaque @inlineOnce
def Function_ID_Encode_loop(codec: ACN, pVal: Vector[UByte], i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= 4))
    require(pVal.size == (5))
    ...
    if (i1 == 4) {
        ...
        val res = Function_ID_Encode_loop(codec, pVal, i1 + 1)
        res
    }
...
def TFunction_ID_ACN_Decode(codec: ACN): EitherMut[ErrorCode, TFunction_ID] =
{
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    val pVal = Function_ID_Decode_loop(codec, Vector.empty[UByte], 0) match {
        case LeftMut(l) =>
            return LeftMut(l)
        case RightMut(bdg) =>
            bdg
...
@opaque @inlineOnce
def Function_ID_Decode_loop(codec: ACN, pVal: Vector[UByte], i1: Int): EitherMut[Int, Vector[UByte]] = {
    require((0 <= i1) && (i1 <= 4))
    ...
    (if (i1 == 4) {
        ...
        val res = Function_ID_Decode_loop(codec, pVal.append(pVal_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
@opaque @inlineOnce
def MultipleArguments_arguments_Encode_loop(codec: ACN, arguments: TMultipleArguments_arguments, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == arguments.nCount) {
        ...
        val res = MultipleArguments_arguments_Encode_loop(codec, arguments, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def MultipleArguments_arguments_ACN_Encode(codec: ACN, pVal: TMultipleArguments, MultipleArguments_n: ULong, arguments: TMultipleArguments_arguments): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    MultipleArguments_arguments_Encode_loop(codec, arguments, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def MultipleArguments_arguments_Decode_loop(codec: ACN, nCount: Int, arguments: Vector[TArgument], i1: Int): EitherMut[Int, Vector[TArgument]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = MultipleArguments_arguments_Decode_loop(codec, nCount, arguments.append(arguments_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def MultipleArguments_arguments_ACN_Decode(codec: ACN, MultipleArguments_n: ULong): EitherMut[Int, TMultipleArguments_arguments] = {
    ...
    val arguments =
        if ((ULong.fromRaw(1) <= MultipleArguments_n) && (MultipleArguments_n <= ULong.fromRaw(4096))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val arguments = MultipleArguments_arguments_Decode_loop(codec, arguments_nCount, Vector.empty[TArgument], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
def TTC_8_1_PerformAFunction_ACN_Encode(pVal: TTC_8_1_PerformAFunction, codec: ACN, bCheckConstraints: Boolean): Either[ErrorCode, Int] =  // acn:21
{
    ...
    TC_8_1_PerformAFunction_function_ID_ACN_Encode(codec, TC_8_1_PerformAFunction_function_ID) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ()
...
@opaque @inlineOnce
def TC_8_1_PerformAFunction_function_ID_Encode_loop(codec: ACN, TC_8_1_PerformAFunction_function_ID: Vector[UByte], i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= 4))
    ...
    if (i1 == 4) {
        ...
        val res = TC_8_1_PerformAFunction_function_ID_Encode_loop(codec, TC_8_1_PerformAFunction_function_ID, i1 + 1)
        res
    }
}.ensuring { (res: Either[Int, Int]) => 
    res match {
...
@opaque @inlineOnce
def TC_8_1_PerformAFunction_function_ID_ACN_Encode(codec: ACN, TC_8_1_PerformAFunction_function_ID: Vector[UByte]): Either[Int, Int] = {
    require(TC_8_1_PerformAFunction_function_ID.size == (5))
    require(codec.base.bitStream.validate_offset_bits((7L * 4)))
    TC_8_1_PerformAFunction_function_ID_Encode_loop(codec, TC_8_1_PerformAFunction_function_ID, 0)
}.ensuring { (res: Either[Int, Int]) => 
    res match {
        case Left(_) =>
            true
        case Right(res) =>
            old(codec).base.buf.length == codec.base.buf.length && codec.base.bitStream.bitIndex == old(codec).base.bitStream.bitIndex + 7L * 4
    }
}
...
@opaque @inlineOnce
def TC_8_1_PerformAFunction_functionArguments_function0_arguments_Encode_loop(codec: ACN, arguments: TMultipleArguments_arguments, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= arguments.nCount))
    require((1 <= arguments.nCount) && (arguments.nCount <= arguments.arr.size) && (arguments.arr.size <= 4096))
    require(codec.base.bitStream.validate_offset_bits((40L * (arguments.nCount - i1))))
    decreases(arguments.nCount - i1)
    if (i1 == arguments.nCount) {
        ...
        val res = TC_8_1_PerformAFunction_functionArguments_function0_arguments_Encode_loop(codec, arguments, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_8_1_PerformAFunction_functionArguments_function0_arguments_ACN_Encode(codec: ACN, pVal: TTC_8_1_PerformAFunction, TC_8_1_PerformAFunction_functionArguments_function0_n: ULong, arguments: TMultipleArguments_arguments): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    TC_8_1_PerformAFunction_functionArguments_function0_arguments_Encode_loop(codec, arguments, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
def TTC_8_1_PerformAFunction_ACN_Decode(codec: ACN): EitherMut[ErrorCode, TTC_8_1_PerformAFunction] =
{
    ...
    val TC_8_1_PerformAFunction_function_ID = TC_8_1_PerformAFunction_function_ID_ACN_Decode(codec) match {
        case LeftMut(l) =>
            return LeftMut(l)
        case RightMut(bdg) =>
            bdg
...
@opaque @inlineOnce
def TC_8_1_PerformAFunction_function_ID_Decode_loop(codec: ACN, TC_8_1_PerformAFunction_function_ID: Vector[UByte], i1: Int): EitherMut[Int, Vector[UByte]] = {
    require((0 <= i1) && (i1 <= 4))
    ...
    (if (i1 == 4) {
        ...
        val res = TC_8_1_PerformAFunction_function_ID_Decode_loop(codec, TC_8_1_PerformAFunction_function_ID.append(TC_8_1_PerformAFunction_function_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
@opaque @inlineOnce
def TC_8_1_PerformAFunction_function_ID_ACN_Decode(codec: ACN): EitherMut[Int, Vector[UByte]] = {
    require(codec.base.bitStream.validate_offset_bits((7L * 4)))
    TC_8_1_PerformAFunction_function_ID_Decode_loop(codec, Vector.empty[UByte], 0)
}.ensuring { (res: EitherMut[Int, Vector[UByte]]) => 
    res match {
        case LeftMut(_) =>
            true
        case RightMut(resVec) =>
            old(codec).base.buf == codec.base.buf && resVec.size == 5 && codec.base.bitStream.bitIndex == old(codec).base.bitStream.bitIndex + 7L * 4
    }
}
...
@ghost @pure
def TC_8_1_PerformAFunction_function_ID_ACN_Decode_pure(codec: ACN): (ACN, EitherMut[Int, Vector[UByte]]) = {
    require(codec.base.bitStream.validate_offset_bits((7L * 4)))
    val cpy = snapshot(codec)
    val res = TC_8_1_PerformAFunction_function_ID_ACN_Decode(cpy)
    (cpy, res)
}
...
@opaque @inlineOnce
def TC_8_1_PerformAFunction_functionArguments_function0_arguments_Decode_loop(codec: ACN, nCount: Int, arguments: Vector[TArgument], i1: Int): EitherMut[Int, Vector[TArgument]] = {
    require((1 <= nCount) && (nCount <= 4096))
    require((0 <= i1) && (i1 <= nCount))
    require(arguments.size == i1)
    require(codec.base.bitStream.validate_offset_bits((40L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_8_1_PerformAFunction_functionArguments_function0_arguments_Decode_loop(codec, nCount, arguments.append(arguments_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_8_1_PerformAFunction_functionArguments_function0_arguments_ACN_Decode(codec: ACN, TC_8_1_PerformAFunction_functionArguments_function0_n: ULong): EitherMut[Int, TMultipleArguments_arguments] = {
    ...
    val arguments =
        if ((ULong.fromRaw(1) <= TC_8_1_PerformAFunction_functionArguments_function0_n) && (TC_8_1_PerformAFunction_functionArguments_function0_n <= ULong.fromRaw(4096))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val arguments = TC_8_1_PerformAFunction_functionArguments_function0_arguments_Decode_loop(codec, arguments_nCount, Vector.empty[TArgument], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
                    val arguments = TMultipleArguments_arguments(arguments_nCount, bdg)
