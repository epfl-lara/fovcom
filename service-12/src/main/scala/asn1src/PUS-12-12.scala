...
@opaque @inlineOnce
def TM_12_12_CheckTransitionReport_transitionCheckReports_Encode_loop(codec: ACN, transitionCheckReports: TTM_12_12_CheckTransitionReport_transitionCheckReports, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == transitionCheckReports.nCount) {
        ...
        val res = TM_12_12_CheckTransitionReport_transitionCheckReports_Encode_loop(codec, transitionCheckReports, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_12_12_CheckTransitionReport_transitionCheckReports_ACN_Encode(codec: ACN, pVal: TTM_12_12_CheckTransitionReport, TM_12_12_CheckTransitionReport_n: ULong, transitionCheckReports: TTM_12_12_CheckTransitionReport_transitionCheckReports): Either[Int, Int] = {
    ...
    TM_12_12_CheckTransitionReport_transitionCheckReports_Encode_loop(codec, transitionCheckReports, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TM_12_12_CheckTransitionReport_transitionCheckReports_Decode_loop(codec: ACN, nCount: Int, transitionCheckReports: Vector[TTransitionNotification], i1: Int): EitherMut[Int, Vector[TTransitionNotification]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TM_12_12_CheckTransitionReport_transitionCheckReports_Decode_loop(codec, nCount, transitionCheckReports.append(transitionCheckReports_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_12_12_CheckTransitionReport_transitionCheckReports_ACN_Decode(codec: ACN, TM_12_12_CheckTransitionReport_n: ULong): EitherMut[Int, TTM_12_12_CheckTransitionReport_transitionCheckReports] = {
    ...
    val transitionCheckReports =
        if ((ULong.fromRaw(1) <= TM_12_12_CheckTransitionReport_n) && (TM_12_12_CheckTransitionReport_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val transitionCheckReports = TM_12_12_CheckTransitionReport_transitionCheckReports_Decode_loop(codec, transitionCheckReports_nCount, Vector.empty[TTransitionNotification], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
