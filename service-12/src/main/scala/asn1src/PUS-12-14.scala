...
@opaque @inlineOnce
def TM_12_14_ParameterMonitoringDefinitionReport_status_Encode_loop(codec: ACN, status: TTM_12_14_ParameterMonitoringDefinitionReport_status, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == status.nCount) {
        ...
        val res = TM_12_14_ParameterMonitoringDefinitionReport_status_Encode_loop(codec, status, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TM_12_14_ParameterMonitoringDefinitionReport_status_ACN_Encode(codec: ACN, pVal: TTM_12_14_ParameterMonitoringDefinitionReport, TM_12_14_ParameterMonitoringDefinitionReport_n: ULong, status: TTM_12_14_ParameterMonitoringDefinitionReport_status): Either[Int, Int] = {
    ...
    TM_12_14_ParameterMonitoringDefinitionReport_status_Encode_loop(codec, status, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TM_12_14_ParameterMonitoringDefinitionReport_status_Decode_loop(codec: ACN, nCount: Int, status: Vector[TParameterMonitoringStatusReport], i1: Int): EitherMut[Int, Vector[TParameterMonitoringStatusReport]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TM_12_14_ParameterMonitoringDefinitionReport_status_Decode_loop(codec, nCount, status.append(status_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TM_12_14_ParameterMonitoringDefinitionReport_status_ACN_Decode(codec: ACN, TM_12_14_ParameterMonitoringDefinitionReport_n: ULong): EitherMut[Int, TTM_12_14_ParameterMonitoringDefinitionReport_status] = {
    ...
    val status =
        if ((TM_12_14_ParameterMonitoringDefinitionReport_n <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val status = TM_12_14_ParameterMonitoringDefinitionReport_status_Decode_loop(codec, status_nCount, Vector.empty[TParameterMonitoringStatusReport], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
