...
@opaque @inlineOnce
def TC_12_23_FunctionalMonitoringDefinition_pmon_ID_Encode_loop(codec: ACN, pmon_ID: TTC_12_23_FunctionalMonitoringDefinition_pmon_ID, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == pmon_ID.nCount) {
        ...
        val res = TC_12_23_FunctionalMonitoringDefinition_pmon_ID_Encode_loop(codec, pmon_ID, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_12_23_FunctionalMonitoringDefinition_pmon_ID_ACN_Encode(codec: ACN, pVal: TTC_12_23_FunctionalMonitoringDefinition, TC_12_23_FunctionalMonitoringDefinition_n2: ULong, pmon_ID: TTC_12_23_FunctionalMonitoringDefinition_pmon_ID): Either[Int, Int] = {
    ...
    TC_12_23_FunctionalMonitoringDefinition_pmon_ID_Encode_loop(codec, pmon_ID, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_12_23_FunctionalMonitoringDefinition_pmon_ID_Decode_loop(codec: ACN, nCount: Int, pmon_ID: Vector[TPMON_ID], i1: Int): EitherMut[Int, Vector[TPMON_ID]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_12_23_FunctionalMonitoringDefinition_pmon_ID_Decode_loop(codec, nCount, pmon_ID.append(pmon_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_12_23_FunctionalMonitoringDefinition_pmon_ID_ACN_Decode(codec: ACN, TC_12_23_FunctionalMonitoringDefinition_n2: ULong): EitherMut[Int, TTC_12_23_FunctionalMonitoringDefinition_pmon_ID] = {
    ...
    val pmon_ID =
        if ((ULong.fromRaw(1) <= TC_12_23_FunctionalMonitoringDefinition_n2) && (TC_12_23_FunctionalMonitoringDefinition_n2 <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val pmon_ID = TC_12_23_FunctionalMonitoringDefinition_pmon_ID_Decode_loop(codec, pmon_ID_nCount, Vector.empty[TPMON_ID], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_Encode_loop(codec: ACN, functionalMonitoringDefinitions: TTC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == functionalMonitoringDefinitions.nCount) {
        ...
        val res = TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_Encode_loop(codec, functionalMonitoringDefinitions, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_ACN_Encode(codec: ACN, pVal: TTC_12_23_AddFunctionalMonitoringDefinition, TC_12_23_AddFunctionalMonitoringDefinition_n1: ULong, functionalMonitoringDefinitions: TTC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_Encode_loop(codec, functionalMonitoringDefinitions, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_Decode_loop(codec: ACN, nCount: Int, functionalMonitoringDefinitions: Vector[TTC_12_23_FunctionalMonitoringDefinition], i1: Int): EitherMut[Int, Vector[TTC_12_23_FunctionalMonitoringDefinition]] = {
    require((1 <= nCount) && (nCount <= 4095))
    require((0 <= i1) && (i1 <= nCount))
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_Decode_loop(codec, nCount, functionalMonitoringDefinitions.append(functionalMonitoringDefinitions_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_ACN_Decode(codec: ACN, TC_12_23_AddFunctionalMonitoringDefinition_n1: ULong): EitherMut[Int, TTC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions] = {
    ...
    val functionalMonitoringDefinitions =
        if ((ULong.fromRaw(1) <= TC_12_23_AddFunctionalMonitoringDefinition_n1) && (TC_12_23_AddFunctionalMonitoringDefinition_n1 <= ULong.fromRaw(4095))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val functionalMonitoringDefinitions = TC_12_23_AddFunctionalMonitoringDefinition_functionalMonitoringDefinitions_Decode_loop(codec, functionalMonitoringDefinitions_nCount, Vector.empty[TTC_12_23_FunctionalMonitoringDefinition], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
