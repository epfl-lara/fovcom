...
def TTC_18_7_CommunicateParametersToOBCP_ACN_Encode(pVal: TTC_18_7_CommunicateParametersToOBCP, codec: ACN, bCheckConstraints: Boolean): Either[ErrorCode, Int] =  // acn:21
{
    ...
    TC_18_7_CommunicateParametersToOBCP_obcp_ID_ACN_Encode(codec, TC_18_7_CommunicateParametersToOBCP_obcp_ID) match {
        case Left(l) =>
...
@opaque @inlineOnce
def TC_18_7_CommunicateParametersToOBCP_obcp_ID_Encode_loop(codec: ACN, TC_18_7_CommunicateParametersToOBCP_obcp_ID: Vector[UByte], i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= 5))
    ...
    if (i1 == 5) {
        ...
        val res = TC_18_7_CommunicateParametersToOBCP_obcp_ID_Encode_loop(codec, TC_18_7_CommunicateParametersToOBCP_obcp_ID, i1 + 1)
        res
    }
...
@opaque @inlineOnce
def TC_18_7_CommunicateParametersToOBCP_obcp_ID_ACN_Encode(codec: ACN, TC_18_7_CommunicateParametersToOBCP_obcp_ID: Vector[UByte]): Either[Int, Int] = {
    require(TC_18_7_CommunicateParametersToOBCP_obcp_ID.size == (6))
    require(codec.base.bitStream.validate_offset_bits((7L * 5)))
    TC_18_7_CommunicateParametersToOBCP_obcp_ID_Encode_loop(codec, TC_18_7_CommunicateParametersToOBCP_obcp_ID, 0)
}.ensuring { (res: Either[Int, Int]) => 
    res match {
        case Left(_) =>
            true
        case Right(res) =>
            old(codec).base.buf.length == codec.base.buf.length && codec.base.bitStream.bitIndex == old(codec).base.bitStream.bitIndex + 7L * 5
    }
}
...
def TTC_18_7_CommunicateParametersToOBCP_ACN_Decode(codec: ACN): EitherMut[ErrorCode, TTC_18_7_CommunicateParametersToOBCP] =
{
    ...
    val TC_18_7_CommunicateParametersToOBCP_obcp_ID = TC_18_7_CommunicateParametersToOBCP_obcp_ID_ACN_Decode(codec) match {
        case LeftMut(l) =>
            return LeftMut(l)
        case RightMut(bdg) =>
            bdg
...
@opaque @inlineOnce
def TC_18_7_CommunicateParametersToOBCP_obcp_ID_Decode_loop(codec: ACN, TC_18_7_CommunicateParametersToOBCP_obcp_ID: Vector[UByte], i1: Int): EitherMut[Int, Vector[UByte]] = {
    require((0 <= i1) && (i1 <= 5))
    ...
    (if (i1 == 5) {
        ...
        val res = TC_18_7_CommunicateParametersToOBCP_obcp_ID_Decode_loop(codec, TC_18_7_CommunicateParametersToOBCP_obcp_ID.append(TC_18_7_CommunicateParametersToOBCP_obcp_ID_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
@opaque @inlineOnce
def TC_18_7_CommunicateParametersToOBCP_obcp_ID_ACN_Decode(codec: ACN): EitherMut[Int, Vector[UByte]] = {
    require(codec.base.bitStream.validate_offset_bits((7L * 5)))
    TC_18_7_CommunicateParametersToOBCP_obcp_ID_Decode_loop(codec, Vector.empty[UByte], 0)
}.ensuring { (res: EitherMut[Int, Vector[UByte]]) => 
    res match {
        case LeftMut(_) =>
            true
        case RightMut(resVec) =>
            old(codec).base.buf == codec.base.buf && resVec.size == 6 && codec.base.bitStream.bitIndex == old(codec).base.bitStream.bitIndex + 7L * 5
    }
}
...
@ghost @pure
def TC_18_7_CommunicateParametersToOBCP_obcp_ID_ACN_Decode_pure(codec: ACN): (ACN, EitherMut[Int, Vector[UByte]]) = {
    require(codec.base.bitStream.validate_offset_bits((7L * 5)))
    val cpy = snapshot(codec)
    val res = TC_18_7_CommunicateParametersToOBCP_obcp_ID_ACN_Decode(cpy)
    (cpy, res)
}
