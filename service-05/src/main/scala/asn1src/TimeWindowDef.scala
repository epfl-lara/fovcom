...
@inline @cCode.inline val ERR_TIMEWINDOWTYPE: Int = 1100 /*selectAll | fromTimeTagToTimeTag | fromTimeTag | toTimeTag */

 

@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOWTYPE: Int = 1103 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOWTYPE: Int = 1104 /*  */
/*-- TTimeTags --------------------------------------------*/
...
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 1030 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 995 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 1025 /* */

@inline @cCode.inline val ERR_TIMETAGS: Int = 1095 /* */
@inline @cCode.inline val ERR_TIMETAGS_FROMTIMETAG_2_2: Int = 1060 /* */
@inline @cCode.inline val ERR_TIMETAGS_TOTIMETAG_2_2: Int = 1090 /* */
...
@inline @cCode.inline val ERR_TIMEWINDOW: Int = 960 /* */
@inline @cCode.inline val ERR_TIMEWINDOW_TIMETAGS_2: Int = 957 /* */

 

@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW: Int = 963 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TYPE_UNINITIALIZED: Int = 964 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TYPE: Int = 821 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS: Int = 955 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 890 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 855 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 885 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_FROMTIMETAG_2_2: Int = 920 /*  */
@inline @cCode.inline val ERR_ACN_ENCODE_TIMEWINDOW_TIMETAGS_TOTIMETAG_2_2: Int = 950 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW: Int = 965 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TYPE: Int = 822 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS: Int = 956 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG: Int = 891 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_FROMTIMETAG_2_2: Int = 856 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAGTOTIMETAG_TOTIMETAG_2_2: Int = 886 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_FROMTIMETAG_2_2: Int = 921 /*  */
@inline @cCode.inline val ERR_ACN_DECODE_TIMEWINDOW_TIMETAGS_TOTIMETAG_2_2: Int = 951 /*  */
