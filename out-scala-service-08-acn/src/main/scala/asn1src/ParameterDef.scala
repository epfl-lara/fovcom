...
@inline @cCode.inline val ERR_PARAMETER_ID: Int = 754 /*param1 */

 

@inline @cCode.inline val ERR_ACN_ENCODE_PARAMETER_ID: Int = 757 /*  */
...
@inline @cCode.inline val ERR_ACN_DECODE_PARAMETER_ID: Int = 758 /*  */
/*-- TParameterValue --------------------------------------------*/
...
@inline @cCode.inline val ERR_PARAMETERVALUE_PARAM1: Int = 759 /*(0 ..255) */

@inline @cCode.inline val ERR_PARAMETERVALUE: Int = 764 /* */
...
@inline @cCode.inline val ERR_PARAMETERMASK_PARAM1: Int = 769 /*(SIZE (16)) */

@inline @cCode.inline val ERR_PARAMETERMASK: Int = 774 /* */
