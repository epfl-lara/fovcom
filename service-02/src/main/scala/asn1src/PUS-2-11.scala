...
@opaque @inlineOnce
def TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_Encode_loop(codec: ACN, dataAcquireRequests: TTC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == dataAcquireRequests.nCount) {
        ...
        val res = TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_Encode_loop(codec, dataAcquireRequests, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_ACN_Encode(codec: ACN, pVal: TTC_2_11_AcquireDataFromLogicalDevices, TC_2_11_AcquireDataFromLogicalDevices_n: ULong, dataAcquireRequests: TTC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests): Either[Int, Int] = {
    ...
    TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_Encode_loop(codec, dataAcquireRequests, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_Decode_loop(codec: ACN, nCount: Int, dataAcquireRequests: Vector[TDataAcquireRequest], i1: Int): EitherMut[Int, Vector[TDataAcquireRequest]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_Decode_loop(codec, nCount, dataAcquireRequests.append(dataAcquireRequests_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_ACN_Decode(codec: ACN, TC_2_11_AcquireDataFromLogicalDevices_n: ULong): EitherMut[Int, TTC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests] = {
    ...
    val dataAcquireRequests =
        if ((ULong.fromRaw(1) <= TC_2_11_AcquireDataFromLogicalDevices_n) && (TC_2_11_AcquireDataFromLogicalDevices_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val dataAcquireRequests = TC_2_11_AcquireDataFromLogicalDevices_dataAcquireRequests_Decode_loop(codec, dataAcquireRequests_nCount, Vector.empty[TDataAcquireRequest], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
