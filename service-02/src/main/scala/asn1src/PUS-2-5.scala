...
@opaque @inlineOnce
def TC_2_5_DistributeRegisterDumpCommands_registerAddresses_Encode_loop(codec: ACN, registerAddresses: TTC_2_5_DistributeRegisterDumpCommands_registerAddresses, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == registerAddresses.nCount) {
        ...
        val res = TC_2_5_DistributeRegisterDumpCommands_registerAddresses_Encode_loop(codec, registerAddresses, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_2_5_DistributeRegisterDumpCommands_registerAddresses_ACN_Encode(codec: ACN, pVal: TTC_2_5_DistributeRegisterDumpCommands, TC_2_5_DistributeRegisterDumpCommands_n: ULong, registerAddresses: TTC_2_5_DistributeRegisterDumpCommands_registerAddresses): Either[Int, Int] = {
    ...
    TC_2_5_DistributeRegisterDumpCommands_registerAddresses_Encode_loop(codec, registerAddresses, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_2_5_DistributeRegisterDumpCommands_registerAddresses_Decode_loop(codec: ACN, nCount: Int, registerAddresses: Vector[TRegisterAddress], i1: Int): EitherMut[Int, Vector[TRegisterAddress]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_2_5_DistributeRegisterDumpCommands_registerAddresses_Decode_loop(codec, nCount, registerAddresses.append(registerAddresses_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_2_5_DistributeRegisterDumpCommands_registerAddresses_ACN_Decode(codec: ACN, TC_2_5_DistributeRegisterDumpCommands_n: ULong): EitherMut[Int, TTC_2_5_DistributeRegisterDumpCommands_registerAddresses] = {
    ...
    val registerAddresses =
        if ((ULong.fromRaw(1) <= TC_2_5_DistributeRegisterDumpCommands_n) && (TC_2_5_DistributeRegisterDumpCommands_n <= ULong.fromRaw(63))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val registerAddresses = TC_2_5_DistributeRegisterDumpCommands_registerAddresses_Decode_loop(codec, registerAddresses_nCount, Vector.empty[TRegisterAddress], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
