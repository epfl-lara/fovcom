...
@opaque @inlineOnce
def TC_2_4_DistributeCpduCommands_cpduCommands_Encode_loop(codec: ACN, cpduCommands: TTC_2_4_DistributeCpduCommands_cpduCommands, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == cpduCommands.nCount) {
        ...
        val res = TC_2_4_DistributeCpduCommands_cpduCommands_Encode_loop(codec, cpduCommands, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_2_4_DistributeCpduCommands_cpduCommands_ACN_Encode(codec: ACN, pVal: TTC_2_4_DistributeCpduCommands, TC_2_4_DistributeCpduCommands_n2: ULong, cpduCommands: TTC_2_4_DistributeCpduCommands_cpduCommands): Either[Int, Int] = {
    ...
    TC_2_4_DistributeCpduCommands_cpduCommands_Encode_loop(codec, cpduCommands, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_2_4_DistributeCpduCommands_cpduCommands_Decode_loop(codec: ACN, nCount: Int, cpduCommands: Vector[TCpduCommand], i1: Int): EitherMut[Int, Vector[TCpduCommand]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_2_4_DistributeCpduCommands_cpduCommands_Decode_loop(codec, nCount, cpduCommands.append(cpduCommands_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_2_4_DistributeCpduCommands_cpduCommands_ACN_Decode(codec: ACN, TC_2_4_DistributeCpduCommands_n2: ULong): EitherMut[Int, TTC_2_4_DistributeCpduCommands_cpduCommands] = {
    ...
    val cpduCommands =
        if ((ULong.fromRaw(1) <= TC_2_4_DistributeCpduCommands_n2) && (TC_2_4_DistributeCpduCommands_n2 <= ULong.fromRaw(255))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val cpduCommands = TC_2_4_DistributeCpduCommands_cpduCommands_Decode_loop(codec, cpduCommands_nCount, Vector.empty[TCpduCommand], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def CPDU_cpduCommands_Encode_loop(codec: ACN, cpduCommands: TCPDU_cpduCommands, i1: Int): Either[Int, Int] = {
    require((0 <= i1) && (i1 <= cpduCommands.nCount))
    require((1 <= cpduCommands.nCount) && (cpduCommands.nCount <= cpduCommands.arr.size) && (cpduCommands.arr.size <= 255))
    require(codec.base.bitStream.validate_offset_bits((16L * (cpduCommands.nCount - i1))))
    decreases(cpduCommands.nCount - i1)
    if (i1 == cpduCommands.nCount) {
        ...
        val res = CPDU_cpduCommands_Encode_loop(codec, cpduCommands, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def CPDU_cpduCommands_ACN_Encode(codec: ACN, pVal: TCPDU, CPDU_n2: ULong, cpduCommands: TCPDU_cpduCommands): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    CPDU_cpduCommands_Encode_loop(codec, cpduCommands, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def CPDU_cpduCommands_Decode_loop(codec: ACN, nCount: Int, cpduCommands: Vector[TCpduCommand], i1: Int): EitherMut[Int, Vector[TCpduCommand]] = {
    require((1 <= nCount) && (nCount <= 255))
    require((0 <= i1) && (i1 <= nCount))
    require(cpduCommands.size == i1)
    require(codec.base.bitStream.validate_offset_bits((16L * (nCount - i1))))
    ...
    (if (i1 == nCount) {
        ...
        val res = CPDU_cpduCommands_Decode_loop(codec, nCount, cpduCommands.append(cpduCommands_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def CPDU_cpduCommands_ACN_Decode(codec: ACN, CPDU_n2: ULong): EitherMut[Int, TCPDU_cpduCommands] = {
    ...
    val cpduCommands =
        if ((ULong.fromRaw(1) <= CPDU_n2) && (CPDU_n2 <= ULong.fromRaw(255))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val cpduCommands = CPDU_cpduCommands_Decode_loop(codec, cpduCommands_nCount, Vector.empty[TCpduCommand], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
...
@opaque @inlineOnce
def TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_Encode_loop(codec: ACN, cpdu: TTC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu, i1: Int): Either[Int, Int] = {
    ...
    if (i1 == cpdu.nCount) {
        ...
        val res = TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_Encode_loop(codec, cpdu, i1 + 1)
        ghostExpr {
            (res match {
                case Left(_) =>
                    ()
...
def TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_ACN_Encode(codec: ACN, pVal: TTC_2_4_DistrubiteCpduCommands_MultipleCpdu, TC_2_4_DistrubiteCpduCommands_MultipleCpdu_n1: ULong, cpdu: TTC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu): Either[Int, Int] = {
    ...
    @ghost val codec_0_1 = snapshot(codec)
    @ghost val codecBeforeLoop_0 = snapshot(codec)
    TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_Encode_loop(codec, cpdu, 0) match {
        case Left(l) =>
            return Left[Int, Int](l)
        case Right(_) =>
            ghostExpr {
...
@opaque @inlineOnce
def TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_Decode_loop(codec: ACN, nCount: Int, cpdu: Vector[TCPDU], i1: Int): EitherMut[Int, Vector[TCPDU]] = {
    ...
    (if (i1 == nCount) {
        ...
        val res = TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_Decode_loop(codec, nCount, cpdu.append(cpdu_arr_i1_), i1 + 1)
        ghostExpr {
            (res match {
                case LeftMut(_) =>
                    ()
...
def TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_ACN_Decode(codec: ACN, TC_2_4_DistrubiteCpduCommands_MultipleCpdu_n1: ULong): EitherMut[Int, TTC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu] = {
    ...
    val cpdu =
        if ((ULong.fromRaw(1) <= TC_2_4_DistrubiteCpduCommands_MultipleCpdu_n1) && (TC_2_4_DistrubiteCpduCommands_MultipleCpdu_n1 <= ULong.fromRaw(127))) then
            ...
            @ghost val codecBeforeLoop_0 = snapshot(codec)
            val cpdu = TC_2_4_DistrubiteCpduCommands_MultipleCpdu_cpdu_Decode_loop(codec, cpdu_nCount, Vector.empty[TCPDU], 0) match {
                case LeftMut(l) =>
                    return LeftMut(l)
                case RightMut(bdg) =>
